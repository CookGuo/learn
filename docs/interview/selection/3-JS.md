---
title: 前端高频面试题-精选篇-Javascript模块 | 前端进阶之旅 - 前端求职面试刷题宝典
source: https://interview.poetries.top/docs/excellent-docs/3-JS模块.html
crawled: 2026-04-08
---

# 前端高频面试题-精选篇-Javascript模块 | 前端进阶之旅 - 前端求职面试刷题宝典

> 原文: [https://interview.poetries.top/docs/excellent-docs/3-JS模块.html](https://interview.poetries.top/docs/excellent-docs/3-JS模块.html)

---

## [#](#_1-数据类型基础) 1 数据类型基础

### [#](#_1-1-js内置类型) 1.1 JS内置类型
...
### [#](#_1-2-null和undefined区别) 1.2 null和undefined区别
...
### [#](#_1-3-null是对象吗-为什么) 1.3 null是对象吗？为什么？

结论: `null`不是对象。

> 解释: 虽然 `typeof null` 会输出 object，但是这只是 JS 存在的一个悠久 Bug。在 JS 的最初版本中使用的是 32 位系统，为了性能考虑使用低位存储变量的类型信息，000 开头代表是对象然而 null 表示为全零，所以将它错误的判断为 object 。

### [#](#_1-4-1-tostring-为什么可以调用) 1.4 '1'.toString()为什么可以调用？
...
### [#](#_1-5-0-1-0-2为什么不等于0-3-如何让其相等) 1.5 0.1+0.2为什么不等于0.3？如何让其相等
...
### [#](#_1-6-如何理解bigint) 1.6 如何理解BigInt
...
### [#](#_1-7-js-整数是怎么表示的) 1.7 JS 整数是怎么表示的

> 通过 Number 类型来表示，遵循 IEEE754 标准，通过 64 位来表示一个数字，（1 + 11 + 52），最大安全数字是 Math.pow(2, 53) - 1，对于 16 位十进制。（符号位 + 指数位 + 小数部分有效位）

### [#](#_1-8-number-的存储空间是多大-如果后台发送了一个超过最大自己的数字怎么办) 1.8 Number() 的存储空间是多大？如果后台发送了一个超过最大自己的数字怎么办

> Math.pow(2, 53) ，53 为有效数字，会发生截断，等于 JS 能支持的最大数字。

## [#](#_2-数据类型检测) 2 数据类型检测

### [#](#_2-1-typeof类型判断) 2.1 typeof类型判断
...
### [#](#_2-2-typeof-于-instanceof-区别) 2.2 typeof 于 instanceof 区别
...
### [#](#_2-3-object-is和-的区别) 2.3 Object.is和===的区别
...
### [#](#_3-2-转boolean) 3.2 转Boolean

> 在条件判断时，除了 `undefined`，`null`， `false`， `NaN`， `''`， `0`， `-0`，其他所有值都转为 `true`，包括所有对象

### [#](#_3-3-对象转原始类型是根据什么流程运行的) 3.3 对象转原始类型是根据什么流程运行的
...
### [#](#_3-4-如何让if-a-1-a-2-条件成立) 3.4 如何让if(a == 1 && a == 2)条件成立
...
### [#](#_4-3-如何解决下面的循环输出问题) 4.3 如何解决下面的循环输出问题
...
## [#](#_5-原型和原型链链) 5 原型和原型链链

### [#](#_5-1-原型-构造函数-实例) 5.1 原型/构造函数/实例
...
### [#](#_5-2-原型对象和构造函数有何关系) 5.2 原型对象和构造函数有何关系
...
### [#](#_5-3-能不能描述一下原型链) 5.3 能不能描述一下原型链
...
### [#](#_6-1-方式1-借助call) 6.1 方式1: 借助call
...
### [#](#_6-3-方式3-将前两种组合) 6.3 方式3：将前两种组合
...
### [#](#_6-4-方式4-组合继承的优化1) 6.4 方式4: 组合继承的优化1
...
### [#](#_6-5-方式5-最推荐使用-组合继承的优化2) 6.5 方式5(最推荐使用): 组合继承的优化2
...
### [#](#_6-6-es6的extends被编译后的javascript代码) 6.6 ES6的extends被编译后的JavaScript代码
...
### [#](#_6-7-从设计思想上谈谈继承本身的问题) 6.7 从设计思想上谈谈继承本身的问题
...
### [#](#_12-1-浏览器中的event-loop) 12.1 浏览器中的Event loop
...
推荐一个可以在线看代码流程的网站：[loupe ](http://latentflip.com/loupe)，看一下[这个学习视频 ](https://www.bilibili.com/video/BV1oV411k7XY/?spm_id_from=333.788.recommend_more_video.-1&vd_source=f48e73dcbb57f07ec3567f1cf5693b6e)
...
### [#](#_12-2-node-中的-event-loop) 12.2 Node 中的 Event loop
...
### [#](#_12-3-实现一个promise-a-规范) 12.3 实现一个Promise A+ 规范
...
### [#](#_12-4-settimeout、promise、async-await-的区别) 12.4 setTimeout、Promise、Async / Await 的区别
...
### [#](#_12-5-settimeout-fn-0-多久才执行-event-loop) 12.5 setTimeout(fn, 0)多久才执行，Event Loop

> setTimeout 按照顺序放到队列里面，然后等待函数调用栈清空之后才开始执行，而这些操作进入队列的顺序，则由设定的延迟时间来决定

### [#](#_12-6-async原理) 12.6 async原理
...
### [#](#_13-1-chrome-devtools查看内存情况) 13.1 Chrome devTools查看内存情况
...
## [#](#_16-对象的几种创建方式) 16 对象的几种创建方式

### [#](#_16-1-工厂模式-创建方式) 16.1 工厂模式,创建方式
...
### [#](#_16-4-组合使用构造函数模式和原型模式) 16.4 组合使用构造函数模式和原型模式
...
### [#](#_17-2-array-3-和array-3-4-的区别) 17.2 Array(3)和Array(3, 4)的区别？
...
### [#](#_17-3-请创建一个长度为100-值都为1的数组) 17.3 请创建一个长度为100，值都为1的数组

```
new Array(100).fill(1)
```

### [#](#_17-4-请创建一个长度为100-值为对应下标的数组) 17.4 请创建一个长度为100，值为对应下标的数组
...
### [#](#_17-5-如何转化类数组成数组) 17.5 如何转化类数组成数组
...
### [#](#_17-6-foreach中return有效果吗-如何中断foreach循环) 17.6 forEach中return有效果吗？如何中断forEach循环？
...
### [#](#_17-7-js判断数组中是否包含某个值) 17.7 JS判断数组中是否包含某个值
...
### [#](#_17-8-js中flat-数组扁平化) 17.8 JS中flat---数组扁平化
...
### [#](#_18-1-说说有几种类型的dom节点) 18.1 说说有几种类型的DOM节点
...
### [#](#_18-2-操作dom节点方法) 18.2 操作DOM节点方法
...
### [#](#_19-1-ajax-有那些优缺点) 19.1 Ajax 有那些优缺点
...
### [#](#_19-2-关于http-xmlhttprequest-ajax的关系) 19.2 关于http,XMLHttpRequest,Ajax的关系
...
### [#](#_19-3-xmlhttprequest的发展历程是怎样的) 19.3 XMLHttpRequest的发展历程是怎样的？
...
### [#](#_19-4-使用xmlhttprequest封装一个get和post请求) 19.4 使用XMLHttpRequest封装一个get和post请求
...
### [#](#_20-1-setinterval存在哪些问题) 20.1 setInterval存在哪些问题？
...
### [#](#_20-2-链式调用settimeout对比setinterval) 20.2 链式调用setTimeout对比setInterval
...
### [#](#_20-3-实现比-settimeout-快-80-倍的定时器) 20.3 实现比 setTimeout 快 80 倍的定时器
...
### [#](#_22-4-说一下requestanimationframe) 22.4 说一下requestAnimationFrame
...
### [#](#_22-5-requestanimationframe对比settimeout) 22.5 requestAnimationFrame对比setTimeout
...
## [#](#_21-谈谈你对for-in-for-of的理解) 21 谈谈你对for in/for of的理解
...
## [#](#_22-javascript-实现对上传图片的压缩) 22 JavaScript 实现对上传图片的压缩？
