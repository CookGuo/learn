---
title: 前端高频面试题-精选篇-Vue模块 | 前端进阶之旅 - 前端求职面试刷题宝典
source: https://interview.poetries.top/docs/excellent-docs/7-Vue.html
crawled: 2026-04-08
---

# 前端高频面试题-精选篇-Vue模块 | 前端进阶之旅 - 前端求职面试刷题宝典

> 原文: [https://interview.poetries.top/docs/excellent-docs/7-Vue.html](https://interview.poetries.top/docs/excellent-docs/7-Vue.html)

---

## [#](#_1-谈谈你对mvvm的理解) 1 谈谈你对MVVM的理解
...
## [#](#_2-谈谈你对spa单页面的理解) 2 谈谈你对SPA单页面的理解
...
## [#](#_3-vue2-x-响应式数据原理) 3 Vue2.x 响应式数据原理
...
## [#](#_4-vue3-x-响应式数据原理) 4 Vue3.x 响应式数据原理
...
### [#](#说说你对-proxy-的理解-proxy-相比于-defineproperty-的优势) 说说你对 proxy 的理解，Proxy 相比于 defineProperty 的优势
...
[proxy详细使用点击查看 ](https://es6.ruanyifeng.com/#docs/proxy)
...
## [#](#_5-vue中如何检测数组变化) 5 Vue中如何检测数组变化
...
## [#](#_6-vue中如何进行依赖收集) 6 Vue中如何进行依赖收集？
...
## [#](#_7-vue实例挂载的过程中发生了什么) 7 Vue实例挂载的过程中发生了什么
...
## [#](#_8-理解vue运行机制全局概览) 8 理解Vue运行机制全局概览
...
## [#](#_9-如何理解vue中模板编译原理) 9 如何理解Vue中模板编译原理
...
### [#](#vue-complier-实现) Vue complier 实现
...
## [#](#_10-vue生命周期相关) 10 Vue生命周期相关

### [#](#vue的生命周期方法有哪些) Vue的生命周期方法有哪些
...
### [#](#vue生命周期钩子是如何实现的) Vue生命周期钩子是如何实现的
...
## [#](#_11-vue-mixin的使用场景和原理) 11 Vue.mixin的使用场景和原理
...
## [#](#_12-vue组件data为什么必须是个函数) 12 Vue组件data为什么必须是个函数？
...
## [#](#_13-nexttick在哪里使用-原理是) 13 nextTick在哪里使用？原理是？
...
## [#](#_14-computed和watch相关) 14 computed和watch相关
...
### [#](#vue3中-watch、watcheffect区别) vue3中 watch、watchEffect区别
...
### [#](#watch中的deep-true是如何实现的) Watch中的deep:true是如何实现的
...
### [#](#vue-computed-实现) Vue computed 实现
...
## [#](#_15-vue-set的实现原理) 15 Vue.set的实现原理
...
## [#](#_16-vue-diff算法相关问题) 16 Vue diff算法相关问题

### [#](#vue为什么需要虚拟dom-优缺点有哪些) Vue为什么需要虚拟DOM？优缺点有哪些
...
### [#](#vue2和vue3和react三者的diff算法有什么区别) Vue2和Vue3和React三者的diff算法有什么区别
...
### [#](#既然vue通过数据劫持可以精准探测数据变化-为什么还需要虚拟dom进行diff检测差异) 既然Vue通过数据劫持可以精准探测数据变化，为什么还需要虚拟DOM进行diff检测差异
...
### [#](#请说明vue中key的作用和原理-谈谈你对它的理解) 请说明Vue中key的作用和原理，谈谈你对它的理解
...
## [#](#_17-vue组件相关) 17 Vue组件相关

### [#](#vue组件为什么只能有一个根元素) Vue组件为什么只能有一个根元素
...
### [#](#vue-extend-作用和原理) Vue.extend 作用和原理
...
### [#](#子组件可以直接改变父组件的数据么-说明原因) 子组件可以直接改变父组件的数据么，说明原因
...
### [#](#什么是递归组件-举个例子说明下) 什么是递归组件？举个例子说明下？
...
## [#](#_18-为什么vue采用异步渲染) 18 为什么Vue采用异步渲染
...
## [#](#_19-v-if和v-show区别) 19 v-if和v-show区别
...
## [#](#_20-v-if和v-for哪个优先级更高) 20 v-if和v-for哪个优先级更高
...
## [#](#_22-vue-是如何实现数据双向绑定的) 22 Vue 是如何实现数据双向绑定的
...
## [#](#_23-v-model双向绑定原理) 23 v-model双向绑定原理

### [#](#v-model实现原理) v-model实现原理
...
### [#](#vue中修饰符-sync与v-model的区别) Vue中修饰符.sync与v-model的区别
...
## [#](#_25-keep-alive原理) 25 keep-alive原理
...
### [#](#怎么缓存当前的组件-缓存后怎么更新) 怎么缓存当前的组件？缓存后怎么更新
...
### [#](#vue-router-动态路由是什么) vue-router 动态路由是什么
...
### [#](#router-link和router-view是如何起作用的) router-link和router-view是如何起作用的
...
### [#](#vue路由hash模式和history模式) Vue路由hash模式和history模式
...
### [#](#了解history有哪些方法吗-说下它们的区别) 了解history有哪些方法吗？说下它们的区别
...
### [#](#如何监听-pushstate-和-replacestate-的变化呢) 如何监听 pushState 和 replaceState 的变化呢？
...
### [#](#route和-router的区别) `$route`和`$router`的区别
...
### [#](#vue-router中如何保护路由) vue-router中如何保护路由
...
[源码位置 ](https://github1s.com/vuejs/router/blob/HEAD/packages/router/src/router.ts#L808-L809)

### [#](#怎么实现路由懒加载呢) 怎么实现路由懒加载呢
...
### [#](#vue要做权限管理该怎么做-控制到按钮级别的权限怎么做) Vue要做权限管理该怎么做？控制到按钮级别的权限怎么做？
...
### [#](#如果让你从零开始写一个vue路由-说说你的思路) 如果让你从零开始写一个vue路由，说说你的思路
...
### [#](#vuex中actions和mutations有什么区别) Vuex中actions和mutations有什么区别
...
可以看一下[vuex-persist ](https://github.com/championswimmer/vuex-persist/blob/master/src/index.ts#L277)内部确实是利用`subscribe`实现的
...
### [#](#你有使用过vuex的module吗) 你有使用过vuex的module吗？
...
[pinna文档 ](https://pinia.web3doc.top/)
...
## [#](#_28-对vue-ssr的理解) 28 对Vue SSR的理解
...
## [#](#_29-vue-修饰符有哪些) 29 Vue 修饰符有哪些

### [#](#vue中修饰符分为以下五种) vue中修饰符分为以下五种
...
## [#](#_30-说说-vue-内置指令) 30 说说 vue 内置指令

## [#](#_31-怎样理解-vue-的单向数据流) 31 怎样理解 Vue 的单向数据流
...
## [#](#_32-写过自定义指令吗-原理是什么) 32 写过自定义指令吗？原理是什么
...
### [#](#vue3-2-自定义全局指令、局部指令) vue3.2 自定义全局指令、局部指令
...
## [#](#_33-vue3相关) 33 Vue3相关

### [#](#vue3-对-vue2-有什么优势) Vue3 对 Vue2 有什么优势
...
### [#](#vue3-和-vue2-的生命周期有什么区别) Vue3 和 Vue2 的生命周期有什么区别
...
### [#](#如何理解composition-api和options-api) 如何理解Composition API和Options API
...
### [#](#composition-api-如何实现逻辑复用) Composition API 如何实现逻辑复用
...
### [#](#composition-api-和-react-hooks-的对比) Composition API 和 React Hooks 的对比
...
### [#](#vue3的设计目标是什么-做了哪些优化) Vue3的设计目标是什么？做了哪些优化
...
### [#](#vue3有了解过吗-能说说跟vue2的区别吗) Vue3有了解过吗？能说说跟vue2的区别吗？
...
### [#](#你知道哪些vue3新特性) 你知道哪些Vue3新特性?

官网列举的最值得注意的新特性：[v3-migration.vuejs.org ](https://v3-migration.vuejs.org/#notable-new-features)
...
### [#](#composition-api-与-options-api-有什么不同) Composition API 与 Options API 有什么不同
...
### [#](#toref和torefs如何使用和最佳方式) toRef和toRefs如何使用和最佳方式
...
### [#](#深入理解为什么需要ref、toref、torefs) 深入理解为什么需要ref、toRef、toRefs
...
### [#](#vue3-2-setup-语法糖汇总) Vue3.2 setup 语法糖汇总
...
### [#](#watch和watcheffect的区别) watch和watchEffect的区别
...
### [#](#说说vue-3-0中tree-shaking特性-举例说明一下) 说说Vue 3.0中Tree shaking特性？举例说明一下？
...
### [#](#用vue3-0-写过组件吗-如果想实现一个-modal你会怎么设计) 用Vue3.0 写过组件吗？如果想实现一个 Modal你会怎么设计？
...
## [#](#_34-vue中v-html会导致哪些问题) 34 Vue中v-html会导致哪些问题
...
## [#](#_35-说下-attrs和-listeners的使用场景) 35 说下$attrs和$listeners的使用场景
...
## [#](#_36-在vue中使用插件的步骤) 36 在Vue中使用插件的步骤

*   采用`ES6`的`import ... from ...`语法或`CommonJS`的`require()`方法引入插件
*   使用全局方法`Vue.use( plugin )`使用插件,可以传入一个选项对象`Vue.use(MyPlugin, { someOption: true })`

## [#](#_37-vue-cli-工程技术集合介绍) 37 vue-cli 工程技术集合介绍

### [#](#构建的-vue-cli-工程都到了哪些技术-它们的作用分别是什么) 构建的 vue-cli 工程都到了哪些技术，它们的作用分别是什么
...
### [#](#vue-cli-工程常用的-npm-命令有哪些) vue-cli 工程常用的 npm 命令有哪些
...
### [#](#请说出vue-cli项目中src目录每个文件夹和文件的用法) 请说出vue cli项目中src目录每个文件夹和文件的用法
...
## [#](#_38-delete和vue-delete删除数组的区别) 38 delete和Vue.delete删除数组的区别？
...
## [#](#_39-v-on可以监听多个方法吗) 39 v-on可以监听多个方法吗？
...
## [#](#_40-v-once的使用场景有哪些) 40 v-once的使用场景有哪些
...
## [#](#_43-class-与-style-如何动态绑定) 43 Class 与 Style 如何动态绑定
...
## [#](#_44-vue为什么没有类似于react中shouldcomponentupdate的生命周期) 44 Vue为什么没有类似于React中shouldComponentUpdate的生命周期
...
## [#](#_45-spa、ssr的区别是什么) 45 SPA、SSR的区别是什么
...
## [#](#_46-vue-loader是什么-它有什么作用) 46 vue-loader是什么？它有什么作用？
...
## [#](#_47-说说你对slot的理解-slot使用场景有哪些) 47 说说你对slot的理解？slot使用场景有哪些
...
## [#](#_48-vue-observable你有了解过吗-说说看) 48 Vue.observable你有了解过吗？说说看

### [#](#observable-是什么) Observable 是什么
...
## [#](#_49-vue中的过滤器了解吗-过滤器的应用场景有哪些) 49 Vue中的过滤器了解吗？过滤器的应用场景有哪些？
...
## [#](#_50-vue项目中有封装过axios吗-主要是封装哪方面的) 50 Vue项目中有封装过axios吗？主要是封装哪方面的？
...
## [#](#_51-说下你的vue项目的目录结构-如果是大型项目你该怎么划分结构和划分组件呢) 51 说下你的vue项目的目录结构，如果是大型项目你该怎么划分结构和划分组件呢
...
## [#](#_52-从0到1自己构架一个vue项目-说说有哪些步骤、哪些重要插件、目录结构你会怎么组织) 52 从0到1自己构架一个vue项目，说说有哪些步骤、哪些重要插件、目录结构你会怎么组织
...
## [#](#_53-vue要做权限管理该怎么做-如果控制到按钮级别的权限怎么做) 53 vue要做权限管理该怎么做？如果控制到按钮级别的权限怎么做
...
## [#](#_54-vue项目中你是如何解决跨域的呢) 54 Vue项目中你是如何解决跨域的呢
...
## [#](#_55-vue项目本地开发完成后部署到服务器后报404是什么原因呢) 55 Vue项目本地开发完成后部署到服务器后报404是什么原因呢
...
## [#](#_56-实际工作中-你总结的vue最佳实践有哪些) 56 实际工作中，你总结的vue最佳实践有哪些
...
## [#](#_57-vue-中使用了哪些设计模式) 57 vue 中使用了哪些设计模式
...
## [#](#_58-如果让你从零开始写一个vuex-说说你的思路) 58 如果让你从零开始写一个vuex，说说你的思路
...
## [#](#_59-使用vue渲染大量数据时应该怎么优化-说下你的思路) 59 使用vue渲染大量数据时应该怎么优化？说下你的思路！
...
## [#](#_60-动态给vue的data添加一个新的属性时会发生什么-怎样解决) 60 动态给vue的data添加一个新的属性时会发生什么？怎样解决？
...
## [#](#_61-你是怎么处理vue项目中的错误的) 61 你是怎么处理vue项目中的错误的？
...
## [#](#_62-spa首屏加载速度慢的怎么解决) 62 SPA首屏加载速度慢的怎么解决
...
[https://tangbc.github.io/vue-virtual-scroll-list ](https://tangbc.github.io/vue-virtual-scroll-list)
...
## [#](#_64-vue项目性能优化-详细) 64 Vue项目性能优化-详细
...
如果你的应用存在非常长或者无限滚动的列表，那么需要采用`虚拟列表`的技术来优化性能，只需要渲染少部分区域的内容，减少重新渲染组件和创建 `dom` 节点的时间。 你可以参考以下开源项目 [vue-virtual-scroll-list ](https://github.com/tangbc/vue-virtual-scroll-list) 和 [vue-virtual-scroller ](https://github.com/Akryum/vue-virtual-scroller) 来优化这种无限列表的场景的
...
*   如果你的 `Vue` 项目只需改善少数营销页面（例如  `/`， `/about`， `/contact` 等）的 `SEO`，那么你可能需要预渲染，在构建时简单地生成针对特定路由的静态 `HTML` 文件。**优点是设置预渲染更简单**，并可以将你的前端作为一个完全静态的站点，具体你可以使用 [prerender-spa-plugin ](https://github.com/chrisvfritz/prerender-spa-plugin) 就可以轻松地添加预渲染
...
## [#](#_65-vue与angular以及react的区别) 65 Vue与Angular以及React的区别？
...
## [#](#_66-vue2高级用法) 66 Vue2高级用法

### [#](#自定义组件model) 自定义组件model
...
## [#](#_67-vue面试考察的高频原理) 67 Vue面试考察的高频原理
...
## [#](#_68-vue面试考点答题分析) 68 Vue面试考点答题分析

### [#](#请说一下响应式数据的理解) 请说一下响应式数据的理解
...
### [#](#nexttick在哪里使用-原理是) nextTick在哪里使用?原理是
...
### [#](#vue-use是干什么的-原理是什么) Vue.use是干什么的?原理是什么
...
### [#](#vue-router有几种钩子函数-具体是什么及执行流程是怎样的) vue-router有几种钩子函数?具体是什么及执行流程是怎样的
