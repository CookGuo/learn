...
> 原文: [https://interview.poetries.top/docs/base/high-frequency.html](https://interview.poetries.top/docs/base/high-frequency.html)
...
### [#](#说说em-px-rem-vh-vw区别) 说说em/px/rem/vh/vw区别
...
*   或者使用淘宝提供的库 [https://github.com/amfe/lib-flexible ](https://github.com/amfe/lib-flexible)
...
### [#](#如果要做优化-css提高性能的方法有哪些) 如果要做优化，CSS提高性能的方法有哪些？
...
### [#](#两栏布局-左边定宽-右边自适应方案) 两栏布局：左边定宽，右边自适应方案
...
## [#](#_2-javascript) 2 JavaScript

### [#](#typeof类型判断) typeof类型判断
...
### [#](#js内存泄露如何检测-场景有哪些) JS内存泄露如何检测？场景有哪些？
...
### [#](#async-await异步总结) async/await异步总结
...
### [#](#event-loop执行机制过程) Event Loop执行机制过程
...
### [#](#从输入url-到网页显示的完整过程) 从输入URL 到网页显示的完整过程
...
### [#](#常见的web前端攻击方式有哪些) 常见的web前端攻击方式有哪些
...
### [#](#移动端h5点击有300ms延迟-该如何解决) 移动端H5点击有300ms延迟，该如何解决
...
### [#](#requestidlecallback和requestanimationframe有什么区别) requestIdleCallback和requestAnimationFrame有什么区别
...
### [#](#script标签的defer和async有什么区别) script标签的defer和async有什么区别
...
### [#](#在实际工作中-你对vue做过哪些优化) 在实际工作中，你对Vue做过哪些优化
...
### [#](#vue3用proxy-实现响应式) vue3用Proxy 实现响应式
...
### [#](#什么是hoiststatic和cachehandler) 什么是HoistStatic和CacheHandler
...
### [#](#ssr和tree-shaking的优化) SSR和Tree-shaking的优化
...
### [#](#setstate和batchupdate机制) setState和batchUpdate机制
...
### [#](#根据jsx写出vnode和render函数) 根据jsx写出vnode和render函数
...
### [#](#虚拟dom-vdom-真的很快吗) 虚拟DOM（vdom）真的很快吗
...
### [#](#react-setstate经典面试题) React setState经典面试题
...
### [#](#react-useeffect闭包陷阱问题) React useEffect闭包陷阱问题
...
### [#](#vue-react-diff-算法有什么区别) Vue React diff 算法有什么区别
...
### [#](#如何统一监听react组件报错) 如何统一监听React组件报错
...
### [#](#在实际工作中-你对react做过哪些优化) 在实际工作中，你对React做过哪些优化
...
### [#](#react和vue的区别-常考) React和Vue的区别（常考）
...
## [#](#_7-react-hooks) 7 React Hooks

### [#](#class组件存在哪些问题) class组件存在哪些问题
...
### [#](#用usestate实现state和setstate功能) 用useState实现state和setState功能
...
### [#](#用useeffect模拟组件生命周期) 用useEffect模拟组件生命周期
...
### [#](#用useeffect模拟willunmount时的注意事项) 用useEffect模拟WillUnMount时的注意事项
...
### [#](#useref和usecontext) useRef和useContext
...
### [#](#usereducer能代替redux吗) useReducer能代替redux吗
...
### [#](#使用usecallback做性能优化) 使用useCallback做性能优化
...
### [#](#class组件逻辑复用有哪些问题) class组件逻辑复用有哪些问题
...
### [#](#hooks组件逻辑复用有哪些好处) Hooks组件逻辑复用有哪些好处

*   变量作用域很明确
*   不会产生组件嵌套

### [#](#hooks使用中的几个注意事项) Hooks使用中的几个注意事项
...
## [#](#_8-webpack) 8 Webpack

### [#](#hash、chunkhash、contenthash区别) hash、chunkhash、contenthash区别
...
### [#](#webpack性能优化-构建速度) webpack性能优化-构建速度
...
### [#](#webpack性能优化-产出代码-线上运行) webpack性能优化-产出代码（线上运行）
...
### [#](#http协议1-0和1-1和2-0有什么区别) HTTP协议1.0和1.1和2.0有什么区别
...
### [#](#websocket和http协议有什么区别) WebSocket和HTTP协议有什么区别
...
### [#](#请描述tcp三次握手和四次挥手) 请描述TCP三次握手和四次挥手
...
### [#](#http跨域请求时为什么要发送options请求) HTTP跨域请求时为什么要发送options请求
...
### [#](#http请求中token、cookie、session有什么区别) HTTP请求中token、cookie、session有什么区别
...
### [#](#什么是https中间人攻击-如何预防-https加密过程、原理) 什么是HTTPS中间人攻击，如何预防（HTTPS加密过程、原理）
...
### [#](#浏览器和nodejs事件循环-event-loop-有什么区别) 浏览器和nodejs事件循环（Event Loop）有什么区别
...
### [#](#nodejs如何开启多进程-进程如何通讯) nodejs如何开启多进程，进程如何通讯
...
### [#](#工作中遇到过哪些项目难点-是如何解决的) 工作中遇到过哪些项目难点，是如何解决的
...
### [#](#如果一个h5很慢-如何排查性能问题) 如果一个H5很慢，如何排查性能问题
...
### [#](#后端一次性返回十万条数据-你该如何渲染) 后端一次性返回十万条数据，你该如何渲染
...
### [#](#请描述js-bridge的实现原理) 请描述js-bridge的实现原理
...
### [#](#如果你是项目前端技术负责人-将如何做技术选型-常考) 如果你是项目前端技术负责人，将如何做技术选型（常考）
...
### [#](#interface和type的区别-常考) interface和type的区别（常考）
...
### [#](#手写js深拷贝-考虑各种数据类型和循环引用) 手写JS深拷贝-考虑各种数据类型和循环引用
...
### [#](#手写curry函数-实现函数柯里化) 手写curry函数，实现函数柯里化
...
### [#](#手写一个lazyman-实现sleep机制) 手写一个LazyMan，实现sleep机制
...
### [#](#手写一个gettype函数-获取详细的数据类型) 手写一个getType函数，获取详细的数据类型
...
### [#](#手写一个js函数-实现数组扁平化array-flatten) 手写一个JS函数，实现数组扁平化Array Flatten
...
### [#](#手写promise加载一张图片) 手写Promise加载一张图片
...
### [#](#实现一个简洁版的promise) 实现一个简洁版的promise
...
### [#](#时间复杂度与空间复杂度基本概念) 时间复杂度与空间复杂度基本概念
...
### [#](#给一个数组-找出其中和为n的两个元素-两数之和) 给一个数组，找出其中和为n的两个元素（两数之和）
...
### [#](#手写判断一个字符串-a-b-c-d-e-f-是否括号匹配) 手写判断一个字符串"{a(b\[c\]d)e}f"是否括号匹配
...
### [#](#工作中遇到过哪些项目难点-是如何解决的-2) 工作中遇到过哪些项目难点，是如何解决的
