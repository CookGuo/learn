...
> 原文: [https://interview.poetries.top/docs/base/improve.html](https://interview.poetries.top/docs/base/improve.html)
...
### [#](#第三个要点-你是否适合这个企业) 第三个要点：你是否适合这个企业？
...
### [#](#第四个要点-聘用你-公司需付出多少) 第四个要点：聘用你，公司需付出多少？
