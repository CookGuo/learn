...
> 原文: [https://interview.poetries.top/qa/1-前端100题自检.html](https://interview.poetries.top/qa/1-前端100题自检.html)
...
![](https://s.poetries.top/uploads/2023/03/f2061f810cc48014.png)
...
![](https://s.poetries.top/uploads/2023/03/8e32d4b091484771.png)
...
## [#](#_22-cool-secret-可访问多长时间) 22. cool\_secret 可访问多长时间？
...
![](https://s.poetries.top/uploads/2023/03/b4cea40dfd40ce5a.png)

现在，`foo` 被调用，打印 `"First"`。

![](https://s.poetries.top/uploads/2023/03/6ce7c2b18831d93e.png)

`foo` 从栈中弹出，`baz` 被调用. 打印 `"Third"`。

![](https://s.poetries.top/uploads/2023/03/dabb86afc159d9aa.png)

WebAPI 不能随时向栈内添加内容。相反，它将回调函数推到名为 _queue_ 的地方。

![](https://s.poetries.top/uploads/2023/03/2931de3f53e8c76e.png)

这就是事件循环开始工作的地方。一个**事件循环**查看栈和任务队列。如果栈是空的，它接受队列上的第一个元素并将其推入栈。

![](https://s.poetries.top/uploads/2023/03/52f022d93a0bdb74.png)
...
![](https://s.poetries.top/uploads/2023/03/bf6a8633c0503b2e.png)
...
![](https://s.poetries.top/uploads/2023/03/6f74ee077a3a5239.png)

接下来我们让`person`等于`null`。

![](https://s.poetries.top/uploads/2023/03/6b88c4fd30c36700.png)
...
![](https://s.poetries.top/uploads/2023/03/4e6e1d7772ac6f28.png)
...
![](https://s.poetries.top/uploads/2023/03/35889afd8ca0aafa.png)
