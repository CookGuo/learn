...
> 原文: [https://interview.poetries.top/docs/base.html](https://interview.poetries.top/docs/base.html)
...
## [#](#一、html、http、web综合问题) 一、HTML、HTTP、WEB综合问题
...
### [#](#_14-web标准以及w3c标准是什么) 14 WEB标准以及W3C标准是什么?
...
### [#](#_20-html5-为什么只需要写-doctype-html) 20 HTML5 为什么只需要写 `<!DOCTYPE HTML>`
...
### [#](#_21-如何在页面上实现一个圆形的可点击区域) 21 如何在页面上实现一个圆形的可点击区域？
...
### [#](#_33-在css-js代码上线之后-开发人员经常会优化性能。从用户刷新网页开始-一次js请求一般情况下有哪些地方会有缓存处理) 33 在CSS/JS代码上线之后，开发人员经常会优化性能。从用户刷新网页开始，一次JS请求一般情况下有哪些地方会有缓存处理？
...
### [#](#_35-web开发中会话跟踪的方法有哪些) 35 web开发中会话跟踪的方法有哪些
...
### [#](#_40-git-fetch和git-pull的区别) 40 git fetch和git pull的区别
...
### [#](#_41-http2-0-做了哪些改进-http3-0-呢) 41 http2.0 做了哪些改进 http3.0 呢
...
### [#](#_3-link与-import的区别) 3 `link`与`@import`的区别
...
### [#](#_7-清除浮动的几种方式-各自的优缺点) 7 清除浮动的几种方式，各自的优缺点
...
### [#](#_16-display-inline-block-什么时候不会显示间隙) 16 display:inline-block 什么时候不会显示间隙？
...
### [#](#_23-css不同选择器的权重-css层叠的规则) 23 CSS不同选择器的权重(CSS层叠的规则)
...
### [#](#_27-base64的原理及优缺点) 27 base64的原理及优缺点
...
### [#](#_62-请列举几种隐藏元素的方法) 62 请列举几种隐藏元素的方法
...
### [#](#_63-rgba-和-opacity-的透明效果有什么不同) 63 rgba() 和 opacity 的透明效果有什么不同
...
### [#](#_64-css-属性-content-有什么作用) 64 css 属性 content 有什么作用
...
### [#](#_65-请解释一下-css3-的-flexbox-弹性盒布局模型-以及适用场景) 65 请解释一下 CSS3 的 Flexbox（弹性盒布局模型）以及适用场景
...
### [#](#_66-经常遇到的浏览器的js兼容性有哪些-解决方法是什么) 66 经常遇到的浏览器的JS兼容性有哪些？解决方法是什么
...
### [#](#_69-css优化、提高性能的方法有哪些) 69 CSS优化、提高性能的方法有哪些
...
### [#](#_70-浏览器是怎样解析css选择器的) 70 浏览器是怎样解析CSS选择器的
...
### [#](#_71-在网页中的应该使用奇数还是偶数的字体) 71 在网页中的应该使用奇数还是偶数的字体
...
### [#](#_72-margin和padding分别适合什么场景使用) 72 margin和padding分别适合什么场景使用
...
### [#](#_73-抽离样式模块怎么写-说出思路) 73 抽离样式模块怎么写，说出思路
...
### [#](#_74-元素竖向的百分比设定是相对于容器的高度吗) 74 元素竖向的百分比设定是相对于容器的高度吗
...
### [#](#_75-全屏滚动的原理是什么-用到了css的那些属性) 75 全屏滚动的原理是什么？ 用到了CSS的那些属性
...
### [#](#_76-什么是响应式设计-响应式设计的基本原理是什么-如何兼容低版本的ie) 76 什么是响应式设计？响应式设计的基本原理是什么？如何兼容低版本的IE
...
### [#](#_77-什么是视差滚动效果-如何给每页做不同的动画) 77 什么是视差滚动效果，如何给每页做不同的动画
...
### [#](#_78-a标签上四个伪类的执行顺序是怎么样的) 78 a标签上四个伪类的执行顺序是怎么样的
...
### [#](#_79-伪元素和伪类的区别和作用) 79 伪元素和伪类的区别和作用
...
### [#](#_80-before-和-after-中双冒号和单冒号有什么区别) 80 ::before 和 :after 中双冒号和单冒号有什么区别
...
### [#](#_81-如何修改chrome记住密码后自动填充表单的黄色背景) 81 如何修改Chrome记住密码后自动填充表单的黄色背景
...
### [#](#_82-网站图片文件-如何点击下载-而非点击预览) 82 网站图片文件，如何点击下载？而非点击预览
...
### [#](#_83-你对-line-height-是如何理解的) 83 你对 line-height 是如何理解的
...
### [#](#_84-line-height-三种赋值方式有何区别-带单位、纯数字、百分比) 84 line-height 三种赋值方式有何区别？（带单位、纯数字、百分比）
...
### [#](#_85-设置元素浮动后-该元素的-display-值会如何变化) 85 设置元素浮动后，该元素的 display 值会如何变化
...
### [#](#_86-让页面里的字体变清晰-变细用css怎么做-ios手机浏览器字体齿轮设置) 86 让页面里的字体变清晰，变细用CSS怎么做？（IOS手机浏览器字体齿轮设置）
...
### [#](#_87-font-style-属性-oblique-是什么意思) 87 font-style 属性 oblique 是什么意思
...
### [#](#_88-display-inline-block-什么时候会显示间隙) 88 display:inline-block 什么时候会显示间隙
...
### [#](#_89-一个高度自适应的div-里面有两个div-一个高度100px-希望另一个填满剩下的高度) 89 一个高度自适应的div，里面有两个div，一个高度100px，希望另一个填满剩下的高度
...
### [#](#_90-css-的渲染层合成是什么-浏览器如何创建新的渲染层) 90 css 的渲染层合成是什么 浏览器如何创建新的渲染层
...
### [#](#_25-谈谈你对vue、react、angular的理解) 25 谈谈你对vue、react、angular的理解
...
### [#](#_35-null-undefined-的区别) 35 null，undefined 的区别
...
### [#](#_36-1-2-3-map-parseint-答案是多少) 36 \["1", "2", "3"\].map(parseInt) 答案是多少
...
### [#](#_37-javascript-代码中的-use-strict-是什么意思) 37 javascript 代码中的"use strict";是什么意思
...
### [#](#_39-js延迟加载的方式有哪些) 39 js延迟加载的方式有哪些
...
### [#](#_41-defer和async) 41 defer和async
...
### [#](#_43-attribute和property的区别是什么) 43 attribute和property的区别是什么
...
### [#](#_45-什么是面向对象编程及面向过程编程-它们的异同和优缺点) 45 什么是面向对象编程及面向过程编程，它们的异同和优缺点
...
### [#](#_47-对web标准、可用性、可访问性的理解) 47 对web标准、可用性、可访问性的理解
...
### [#](#_48-如何通过js判断一个数组) 48 如何通过JS判断一个数组
...
### [#](#_49-谈一谈let与var的区别) 49 谈一谈let与var的区别
...
### [#](#_50-map与foreach的区别) 50 map与forEach的区别
...
### [#](#_51-谈一谈你理解的函数式编程) 51 谈一谈你理解的函数式编程
...
### [#](#_52-谈一谈箭头函数与普通函数的区别) 52 谈一谈箭头函数与普通函数的区别？
...
### [#](#_53-谈一谈函数中this的指向) 53 谈一谈函数中this的指向
...
### [#](#_56-谈谈你对原生javascript了解程度) 56 谈谈你对原生Javascript了解程度
...
### [#](#_57-js动画与css动画区别及相应实现) 57 Js动画与CSS动画区别及相应实现
...
### [#](#_58-js-数组和对象的遍历方式-以及几种方式的比较) 58 JS 数组和对象的遍历方式，以及几种方式的比较
...
### [#](#_60-说一下vue的双向绑定数据的原理) 60 说一下Vue的双向绑定数据的原理
...
### [#](#_61-let-var-const区别) 61 let var const区别
...
### [#](#_63-如何渲染几万条数据并不卡住界面) 63 如何渲染几万条数据并不卡住界面
...
### [#](#_64-希望获取到页面中所有的checkbox怎么做) 64 希望获取到页面中所有的checkbox怎么做？
...
### [#](#_65-怎样添加、移除、移动、复制、创建和查找节点) 65 怎样添加、移除、移动、复制、创建和查找节点
...
### [#](#_67-javascript中callee和caller的作用) 67 Javascript中callee和caller的作用？
...
### [#](#_68-window-onload和-document-ready) 68 window.onload和$(document).ready
...
### [#](#_69-addeventlistener-和attachevent-的区别) 69 addEventListener()和attachEvent()的区别
...
### [#](#_70-获取页面所有的checkbox) 70 获取页面所有的checkbox
...
### [#](#_72-设计题-想实现一个对页面某个节点的拖曳-如何做-使用原生js) 72 （设计题）想实现一个对页面某个节点的拖曳？如何做？（使用原生JS）
...
### [#](#_73-javascript全局函数和全局变量) 73 Javascript全局函数和全局变量
...
### [#](#_74-使用js实现一个持续的动画效果) 74 使用js实现一个持续的动画效果
...
### [#](#_75-封装一个函数-参数是定时器的时间-then执行回调函数) 75 封装一个函数，参数是定时器的时间，.then执行回调函数
...
### [#](#_79-谈谈你对websocket的理解) 79 谈谈你对WebSocket的理解
...
### [#](#_80-尽可能多的说出你对-electron-的理解) 80 尽可能多的说出你对 Electron 的理解
...
### [#](#_84-什么是单线程-和异步的关系) 84 什么是单线程，和异步的关系
...
### [#](#_85-前端面试之hybrid) 85 前端面试之hybrid

> [http://blog.poetries.top/2018/10/21/fe-interview-hybrid/ ](http://blog.poetries.top/2018/10/21/fe-interview-hybrid/)
...
### [#](#_86-前端面试之组件化) 86 前端面试之组件化

> [http://blog.poetries.top/2018/10/21/fe-interview-component/ ](http://blog.poetries.top/2018/10/21/fe-interview-component/)

### [#](#_87-前端面试之mvvm浅析) 87 前端面试之MVVM浅析

> [http://blog.poetries.top/2018/10/21/fe-interview-mvvm/ ](http://blog.poetries.top/2018/10/21/fe-interview-mvvm/)

### [#](#_88-实现效果-点击容器内的图标-图标边框变成border-1px-solid-red-点击空白处重置) 88 实现效果，点击容器内的图标，图标边框变成border 1px solid red，点击空白处重置
...
### [#](#_89-请简单实现双向数据绑定mvvm) 89 请简单实现双向数据绑定MVVM
...
### [#](#_90-实现storage-使得该对象为单例-并对localstorage进行封装设置值setitem-key-value-和getitem-key) 90 实现Storage，使得该对象为单例，并对`localStorage`进行封装设置值setItem(key,value)和getItem(key)
...
### [#](#_91-谈谈你对event-loop的理解) 91 谈谈你对Event Loop的理解
...
### [#](#_92-javascript-对象生命周期的理解) 92 JavaScript 对象生命周期的理解
...
### [#](#_93-我现在有一个canvas-上面随机布着一些黑块-请实现方法-计算canvas上有多少个黑块) 93 我现在有一个`canvas`，上面随机布着一些黑块，请实现方法，计算canvas上有多少个黑块
...
### [#](#_94-现在要你完成一个dialog组件-说说你设计的思路-它应该有什么功能) 94 现在要你完成一个Dialog组件，说说你设计的思路？它应该有什么功能？
...
### [#](#_95-ajax、axios、fetch区别) 95 ajax、axios、fetch区别
...
### [#](#_96-javascript的组成) 96 JavaScript的组成
...
### [#](#_97-检测浏览器版本有哪些方式) 97 检测浏览器版本有哪些方式？
...
### [#](#_98-介绍js有哪些内置对象) 98 介绍JS有哪些内置对象
...
### [#](#_99-说几条写javascript的基本规范) 99 说几条写JavaScript的基本规范
...
### [#](#_100-如何编写高性能的javascript) 100 如何编写高性能的JavaScript
...
### [#](#_101-描述浏览器的渲染过程-dom树和渲染树的区别) 101 描述浏览器的渲染过程，DOM树和渲染树的区别
...
### [#](#_102-script-的位置是否会影响首屏显示时间) 102 script 的位置是否会影响首屏显示时间
...
### [#](#_103-介绍-dom-的发展) 103 介绍 DOM 的发展
...
### [#](#_104-介绍dom0-dom2-dom3事件处理方式区别) 104 介绍DOM0，DOM2，DOM3事件处理方式区别
...
### [#](#_105-区分什么是-客户区坐标-、-页面坐标-、-屏幕坐标) 105 区分什么是“客户区坐标”、“页面坐标”、“屏幕坐标”
...
### [#](#_106-javascript垃圾回收方法) 106 Javascript垃圾回收方法
...
### [#](#_107-请解释一下-javascript-的同源策略) 107 请解释一下 JavaScript 的同源策略
...
### [#](#_108-如何删除一个cookie) 108 如何删除一个cookie
...
### [#](#_109-页面编码和被请求的资源编码如果不一致如何处理) 109 页面编码和被请求的资源编码如果不一致如何处理
...
### [#](#_110-把-script-放在-body-之前和之后有什么区别-浏览器会如何解析它们) 110 把`<script>`放在`</body>`之前和之后有什么区别？浏览器会如何解析它们？
...
### [#](#_111-javascript-中-调用函数有哪几种方式) 111 JavaScript 中，调用函数有哪几种方式
...
### [#](#_112-列举一下javascript数组和对象有哪些原生方法) 112 列举一下JavaScript数组和对象有哪些原生方法？
...
### [#](#_113-array-slice-与-array-splice-的区别) 113 Array.slice() 与 Array.splice() 的区别？
...
### [#](#_115-web应用从服务器主动推送data到客户端有那些方式) 115 WEB应用从服务器主动推送Data到客户端有那些方式
...
### [#](#_117-有四个操作会忽略enumerable为false的属性) 117 有四个操作会忽略enumerable为false的属性
...
### [#](#_119-为什么通常在发送数据埋点请求的时候使用的是-1x1-像素的透明-gif-图片) 119 为什么通常在发送数据埋点请求的时候使用的是 1x1 像素的透明 gif 图片
...
### [#](#_120-在输入框中如何判断输入的是一个正确的网址) 120 在输入框中如何判断输入的是一个正确的网址
...
### [#](#_122-常用设计模式有哪些并举例使用场景) 122 常用设计模式有哪些并举例使用场景
...
### [#](#_123-raf-和-ric-是什么) 123 RAF 和 RIC 是什么
...
### [#](#_125-前端性能定位、优化指标以及计算方法) 125 前端性能定位、优化指标以及计算方法
...
### [#](#_126-谈谈你对函数是一等公民的理解) 126 谈谈你对函数是一等公民的理解
...
## [#](#四、jquery相关) 四、jQuery相关

### [#](#_1-你觉得jquery源码有哪些写的好的地方) 1 你觉得jQuery源码有哪些写的好的地方
...
### [#](#_19-是否用过-jquery-的-deferred) 19 是否用过 jQuery 的 Deferred

         

## [#](#五、bootstrap相关) 五、Bootstrap相关
...
### [#](#_14-bootstrap有哪些关于img的class) 14 Bootstrap有哪些关于img的class？
...
### [#](#_1-优化-webpack-打包体积的思路) 1 优化 webpack 打包体积的思路
...
### [#](#_2-优化-webpack-打包效率的方法) 2 优化 webpack 打包效率的方法
...
### [#](#_5-说一下webpack的一些plugin-怎么使用webpack对项目进行优化) 5 说一下webpack的一些plugin，怎么使用webpack对项目进行优化
...
### [#](#_6-webpack-plugin-和-loader-的区别) 6 webpack Plugin 和 Loader 的区别
...
### [#](#_7-tree-shaking-的原理是什么) 7 tree shaking 的原理是什么
...
### [#](#_8-common-js-和-es6-中模块引入的区别) 8 common.js 和 es6 中模块引入的区别
...
### [#](#_2-vue-nexttick-原理) 2 Vue nextTick 原理
...
### [#](#_3-vue-diff-原理) 3 Vue diff 原理

### [#](#_4-路由原理-history-和-hash-两种路由方式的特点) 4 路由原理 history 和 hash 两种路由方式的特点
...
### [#](#_18-手写-promise-all-和-race-京东) 18 手写 promise.all 和 race（京东）
...
### [#](#_19-手写-实现一个寄生组合继承) 19 手写-实现一个寄生组合继承
...
### [#](#_21-手写-settimeout-模拟实现-setinterval-阿里) 21 手写-setTimeout 模拟实现 setInterval（阿里）
...
### [#](#_22-手写-发布订阅模式-字节) 22 手写-发布订阅模式（字节）
...
### [#](#_24-将虚拟-dom-转化为真实-dom-类似的递归题-必考) 24 将虚拟 Dom 转化为真实 Dom（类似的递归题-必考）
...
### [#](#_25-手写-实现一个对象的-flatten-方法-阿里) 25 手写-实现一个对象的 flatten 方法（阿里）
...
### [#](#_26-手写-判断括号字符串是否有效-小米) 26 手写-判断括号字符串是否有效（小米）
...
### [#](#_27-手写-查找数组公共前缀-美团) 27 手写-查找数组公共前缀（美团）
...
### [#](#_28-手写-字符串最长的不重复子串) 28 手写-字符串最长的不重复子串
