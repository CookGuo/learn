...
> 原文: [https://interview.poetries.top/docs/base/handwritten.html](https://interview.poetries.top/docs/base/handwritten.html)
...
## [#](#_3-实现instanceof) 3 实现instanceOf
...
## [#](#_10-实现promise相关方法) 10 实现Promise相关方法

### [#](#_1-实现promise的resolve) 1 实现Promise的resolve
...
### [#](#_2-实现-promise-reject) 2 实现 Promise.reject
...
### [#](#_3-实现-promise-prototype-finally) 3 实现 Promise.prototype.finally
...
### [#](#_4-实现-promise-all) 4 实现 Promise.all
...
### [#](#_5-实现promise-allsettle) 5 实现promise.allsettle
...
### [#](#_6-实现-promise-race) 6 实现 Promise.race
...
### [#](#_7-实现一个简版promise) 7 实现一个简版Promise
...
### [#](#_8-promise-实现-详细) 8 Promise 实现-详细
...
### [#](#_10-完整实现promises-a-规范) 10 完整实现Promises/A+规范
...
## [#](#_16-实现async-await) 16 实现async/await
...
## [#](#_17-基于generator函数实现async-await原理) 17 基于Generator函数实现async/await原理
...
## [#](#_18-实现es6的const) 18 实现ES6的const
...
## [#](#_19-实现一个迭代器生成函数) 19 实现一个迭代器生成函数

### [#](#_1-es6对迭代器的实现) 1 ES6对迭代器的实现
...
## [#](#_20-实现es6的extends) 20 实现ES6的extends
...
## [#](#_21-实现object-create) 21 实现Object.create
...
## [#](#_22-实现object-freeze) 22 实现Object.freeze
...
## [#](#_23-实现object-is) 23 实现Object.is
...
## [#](#_24-实现一个compose函数) 24 实现一个compose函数
...
## [#](#_25-settimeout与setinterval实现) 25 setTimeout与setInterval实现

### [#](#_1-settimeout-模拟实现-setinterval) 1 setTimeout 模拟实现 setInterval
...
### [#](#_2-setinterval-模拟实现-settimeout) 2 setInterval 模拟实现 setTimeout
...
## [#](#_26-实现node的require方法) 26 实现Node的require方法
...
### [#](#_1-将虚拟-dom-转化为真实-dom) 1 将虚拟 Dom 转化为真实 Dom
...
### [#](#_2-实现事件总线结合vue应用) 2 实现事件总线结合Vue应用
...
> 在日常的开发中，大家用到`EventBus/EventEmitter`往往提供比这五个方法多的多的多的方法。但在面试过程中，如果大家能够完整地实现出这五个方法，已经非常可以说明问题了，因此这个`EventBus`希望大家可以熟练掌握。学有余力的同学，推荐阅读[FaceBook推出的通用EventEmiiter库的源码 ](https://github.com/facebook/emitter)，相信你会有更多收获。

### [#](#_3-实现一个双向绑定) 3 实现一个双向绑定
...
### [#](#_6-实现vue-reactive响应式) 6 实现Vue reactive响应式
...
### [#](#_10-实现redux-thunk) 10 实现redux-thunk
...
### [#](#_4-实现findindex方法) 4 实现findIndex方法
...
### [#](#_9-实现数组扁平化flat方法) 9 实现数组扁平化flat方法
...
### [#](#_10-实现array-isarray方法) 10 实现Array.isArray方法
...
### [#](#_11-实现array-of方法) 11 实现Array.of方法
...
### [#](#_14-数组中的数据根据key去重) 14 数组中的数据根据key去重
...
### [#](#_15-类数组转化为数组的方法) 15 类数组转化为数组的方法
...
### [#](#_5-用正则写一个根据name获取cookie中的值的方法) 5 用正则写一个根据name获取cookie中的值的方法
...
## [#](#_31-函数柯里化相关) 31 函数柯里化相关

### [#](#_1-实现一个js函数柯里化) 1 实现一个JS函数柯里化
...
### [#](#_2-请实现一个-add-函数-满足以下功能) 2 请实现一个 add 函数，满足以下功能
...
### [#](#_3-实现-5-add-3-minus-2-功能) 3 实现 (5).add(3).minus(2) 功能
...
### [#](#_1-查找字符串中出现最多的字符和个数) 1 查找字符串中出现最多的字符和个数
...
### [#](#_2-实现一个管理本地缓存过期的函数) 2 实现一个管理本地缓存过期的函数
...
### [#](#_3-实现lodash的chunk方法-数组按指定长度拆分) 3 实现lodash的chunk方法--数组按指定长度拆分
...
### [#](#_4-手写深度比较isequal) 4 手写深度比较isEqual
...
### [#](#_5-实现一个json-stringify) 5 实现一个JSON.stringify
...
### [#](#_6-实现一个json-parse) 6 实现一个JSON.parse
...
### [#](#_7-解析-url-params-为对象) 7 解析 URL Params 为对象
...
### [#](#_9-实现一个函数判断数据类型) 9 实现一个函数判断数据类型
...
### [#](#_10-对象数组列表转成树形结构-处理菜单) 10 对象数组列表转成树形结构（处理菜单）
...
### [#](#_11-树形结构转成列表-处理菜单) 11 树形结构转成列表（处理菜单）
...
## [#](#_35-算法数据结构) 35 算法数据结构

### [#](#_1-实现一个链表结构) 1 实现一个链表结构
...
### [#](#_1-实现一个-sleep-函数-比如-sleep-1000-意味着等待1000毫秒) 1 实现一个 sleep 函数，比如 sleep(1000) 意味着等待1000毫秒
...
### [#](#_2-给定两个数组-写一个方法来计算它们的交集) 2 给定两个数组，写一个方法来计算它们的交集
...
### [#](#_5-实现有并行限制的-promise-调度器) 5 实现有并行限制的 Promise 调度器
...
### [#](#_7-实现-getvalue-setvalue-函数来获取path对应的值) 7 实现 getValue/setValue 函数来获取path对应的值
...
### [#](#_8-创建10个标签-点击的时候弹出来对应的序号) 8 创建10个标签，点击的时候弹出来对应的序号
...
### [#](#_10-请实现-dom2json-一个函数-可以把一个-dom-节点输出-json-的格式) 10 请实现 DOM2JSON 一个函数，可以把一个 DOM 节点输出 JSON 的格式
...
### [#](#_11-分片思想解决大数据量渲染问题) 11 分片思想解决大数据量渲染问题
...
### [#](#_12-实现一个add方法完成两个大数相加) 12 实现一个add方法完成两个大数相加
...
### [#](#_13-怎么在制定数据源里面生成一个长度为-n-的不重复随机数组-能有几种方法-时间复杂度多少-字节) 13 怎么在制定数据源里面生成一个长度为 n 的不重复随机数组 能有几种方法 时间复杂度多少（字节）
...
### [#](#_14-查找数组公共前缀-美团) 14 查找数组公共前缀（美团）
...
### [#](#_15-判断括号字符串是否有效-小米) 15 判断括号字符串是否有效（小米）
...
### [#](#_16-实现一个padstart-或padend-的polyfil) 16 实现一个padStart()或padEnd()的polyfil
...
### [#](#_17-设计一个方法提取对象中所有value大于2的键值对并返回最新的对象) 17 设计一个方法提取对象中所有value大于2的键值对并返回最新的对象
...
### [#](#_19-基于promise-all实现ajax的串行和并行) 19 基于Promise.all实现Ajax的串行和并行
...
### [#](#_20-修改嵌套层级很深对象的-key) 20 修改嵌套层级很深对象的 key
