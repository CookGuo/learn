---
title: 将图片转成datauri嵌入到html|Nodejs专题系列 | Node学习指南
source: https://interview.poetries.top/fe-node-docs/nodejs-docs/advance/-将图片转成datauri嵌入到html.html
crawled: 2026-04-09
---

# 将图片转成datauri嵌入到html|Nodejs专题系列 | Node学习指南

> 原文: [https://interview.poetries.top/fe-node-docs/nodejs-docs/advance/-将图片转成datauri嵌入到html.html](https://interview.poetries.top/fe-node-docs/nodejs-docs/advance/-将图片转成datauri嵌入到html.html)

---

## [#](#问题-将图片转成datauri) 问题：将图片转成datauri
