...
# [#](#《使用-eventproxy-控制并发》) 《使用 eventproxy 控制并发》
...
_注意，cnodejs.org 网站有并发连接数的限制，所以当请求发送太快的时候会导致返回值为空或报错。建议一次抓取3个主题即可。文中的40只是为了方便讲解_
...
![](https://s.poetries.top/images/202202211658289.png)
...
![](https://s.poetries.top/images/202202211658779.png)
