---
title: # 《使用 async 控制并发》
source: https://interview.poetries.top/fe-node-docs/nodejs-docs/advance/-使用 async 控制并发.html
crawled: 2026-04-09
---

# # 《使用 async 控制并发》

> 原文: [https://interview.poetries.top/fe-node-docs/nodejs-docs/advance/-使用 async 控制并发.html](https://interview.poetries.top/fe-node-docs/nodejs-docs/advance/-使用 async 控制并发.html)

---

# [#](#《使用-async-控制并发》) 《使用 async 控制并发》
...
![](https://s.poetries.top/images/202202211657162.png)
...
![](https://s.poetries.top/images/202202211657780.png)
