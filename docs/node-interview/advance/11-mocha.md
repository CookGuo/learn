...
# [#](#《测试用例-mocha-should-istanbul》) 《测试用例：mocha，should，istanbul》
...
![](https://s.poetries.top/images/202202211657927.png)
...
![](https://s.poetries.top/images/202202211657946.png)
...
![](https://s.poetries.top/images/202202211657443.png)

可以看到，我们其中的分支覆盖率是 91.67%，行覆盖率是 87.5%。

打开 `open coverage/lcov-report/index.html` 看看

![](https://s.poetries.top/images/202202211657290.png)
