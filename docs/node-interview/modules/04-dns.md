...
## [#](#域名解析-dns-lookup) 域名解析：dns.lookup()
...
## [#](#域名解析-dns-resolve4) 域名解析：dns.resolve4()
...
## [#](#dns-lookup-跟dns-resolve4-的区别) dns.lookup()跟dns.resolve4()的区别
...
官方文档：https://nodejs.org/api/dns.html#dns\_dns\_resolve4\_hostname\_callback
