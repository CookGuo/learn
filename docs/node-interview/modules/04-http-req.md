---
title: 网络服务 http req|Nodejs专题系列 | Node学习指南
source: https://interview.poetries.top/fe-node-docs/nodejs-docs/modules/-4.3 网络服务 http req.html
crawled: 2026-04-09
---

# 网络服务 http req|Nodejs专题系列 | Node学习指南

> 原文: [https://interview.poetries.top/fe-node-docs/nodejs-docs/modules/-4.3 网络服务 http req.html](https://interview.poetries.top/fe-node-docs/nodejs-docs/modules/-4.3 网络服务 http req.html)
...
### [#](#例子一-获取httpversion-method-url) 例子一：获取httpVersion/method/url
...
### [#](#例子一-获取httpversion-statuscode-statusmessage) 例子一：获取httpVersion/statusCode/statusMessage
...
## [#](#事件对比-aborted、close) 事件对比：aborted、close
...
以下代码来自nodejs源码（\_http\_server.js）
...
官方文档： https://nodejs.org/api/http.html#http\_class\_http\_incomingmessage
