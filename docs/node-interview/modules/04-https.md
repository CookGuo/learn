...
#### [#](#_3、生成证书签名请求-csr是-certificate-signing-request的意思-。) 3、生成证书签名请求（csr是 Certificate Signing Request的意思）。
...
## [#](#进阶例子-访问安全证书不受信任的网站) 进阶例子：访问安全证书不受信任的网站
...
### [#](#方法1-忽略安全警告-继续访问) 方法1：忽略安全警告，继续访问
...
### [#](#方法2-将12306的ca加入受信列表) 方法2：将12306的CA加入受信列表
...
#### [#](#_1、下载-12306-的ca证书) 1、下载 12306 的CA证书
...
#### [#](#_2、将der格式的ca证书-转成pem格式) 2、将der格式的CA证书，转成pem格式
...
#### [#](#_3、修改node-https的配置) 3、修改node https的配置
...
[那些证书相关的玩意儿(SSL,X.509,PEM,DER,CRT,CER,KEY,CSR,P12等) (opens new window)](http://www.cnblogs.com/guogangj/p/4118605.html)
