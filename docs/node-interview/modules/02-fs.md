---
title: 文件系统操作 fs|Nodejs专题系列 | Node学习指南
source: https://interview.poetries.top/fe-node-docs/nodejs-docs/modules/-2.0 文件系统操作 fs.html
crawled: 2026-04-09
---

# 文件系统操作 fs|Nodejs专题系列 | Node学习指南

> 原文: [https://interview.poetries.top/fe-node-docs/nodejs-docs/modules/-2.0 文件系统操作 fs.html](https://interview.poetries.top/fe-node-docs/nodejs-docs/modules/-2.0 文件系统操作 fs.html)
