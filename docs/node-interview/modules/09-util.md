...
## [#](#debuglog-section) debuglog(section)
...
## [#](#将方法标识为作废-util-deprecate-fn-str) 将方法标识为作废：util.deprecate(fn, str)
...
## [#](#格式化打印-util-format-format-args) 格式化打印：util.format(format\[, ...args\])
...
## [#](#调试方法-util-inspect-obj-options) 调试方法：util.inspect(obj\[, options\])
