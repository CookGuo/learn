---
title: 本地路径处理 path|Nodejs专题系列 | Node学习指南
source: https://interview.poetries.top/fe-node-docs/nodejs-docs/modules/-1.0 本地路径处理 path.html
crawled: 2026-04-09
---

# 本地路径处理 path|Nodejs专题系列 | Node学习指南

> 原文: [https://interview.poetries.top/fe-node-docs/nodejs-docs/modules/-1.0 本地路径处理 path.html](https://interview.poetries.top/fe-node-docs/nodejs-docs/modules/-1.0 本地路径处理 path.html)
...
### [#](#path-resolve-paths) path.resolve(\[...paths\])
...
### [#](#path-parse-filepath) path.parse(filepath)
...
官方文档：https://nodejs.org/api/path.html#path\_path
