...
### [#](#通过-new-buffer-array) 通过 new Buffer(array)
...
### [#](#通过-buffer-alloc-length) 通过 Buffer.alloc(length)
...
### [#](#buf-compare-target-targetstart-targetend-sourcestart-sourceend) buf.compare(target\[, targetStart\[, targetEnd\[, sourceStart\[, sourceEnd\]\]\]\])
...
### [#](#buffer-compare-buf1-buf2) Buffer.compare(buf1, buf2)
...
## [#](#从buffer-from-62-谈起) 从Buffer.from(\[62\])谈起
...
## [#](#buffer连接-buffer-concat-list-totallength) buffer连接：Buffer.concat(list\[, totalLength\])
...
## [#](#拷贝-buf-copy-target-targetstart-sourcestart-sourceend) 拷贝：buf.copy(target\[, targetStart\[, sourceStart\[, sourceEnd\]\]\])
...
## [#](#查找-buf-indexof-value-byteoffset-encoding) 查找：buf.indexOf(value\[, byteOffset\]\[, encoding\])
...
## [#](#写-buf-write-string-offset-length-encoding) 写：buf.write(string\[, offset\[, length\]\]\[, encoding\])
...
## [#](#填充-buf-fill-value-offset-end-encoding) 填充：buf.fill(value\[, offset\[, end\]\]\[, encoding\])
...
## [#](#转成字符串-buf-tostring-encoding-start-end) 转成字符串: buf.toString(\[encoding\[, start\[, end\]\]\])
...
## [#](#转成json字符串-buf-tojson) 转成JSON字符串：buf.toJSON()
...
## [#](#遍历-buf-values-、buf-keys-、buf-entries) 遍历：buf.values()、buf.keys()、buf.entries()
...
## [#](#截取-buf-slice-start-end) 截取：buf.slice(\[start\[, end\]\])
