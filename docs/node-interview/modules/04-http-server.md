...
### [#](#http版本、http-method、headers、url) HTTP版本、HTTP method、headers、url
...
### [#](#connect-vs-connection) connect vs connection
...
### [#](#其他server-listen) 其他server.listen()
...
### [#](#网络超时-server-settimeout-msecs-callback) 网络超时 server.setTimeout(msecs, callback)
