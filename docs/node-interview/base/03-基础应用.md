---
title: 基础应用|Nodejs专题系列 | Node学习指南
source: https://interview.poetries.top/fe-node-docs/nodejs-docs/base/03-基础应用.html
crawled: 2026-04-09
---

# 基础应用|Nodejs专题系列 | Node学习指南

> 原文: [https://interview.poetries.top/fe-node-docs/nodejs-docs/base/03-基础应用.html](https://interview.poetries.top/fe-node-docs/nodejs-docs/base/03-基础应用.html)
