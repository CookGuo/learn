...
## [#](#node-9下import-export使用简单须知) Node 9下import/export使用简单须知
...
### [#](#与require-区别) 与require()区别

| 能力 | 描述 | require() | import |
| --- | --- | --- | --- |
| NODE\_PATH | 从NODE\_PATH加载依赖模块 | Y | N |
...
## [#](#loader-hooks模式使用) Loader Hooks模式使用
...
注意： 目前Node对`import/export`的支持现在还是`Stability: 1 - Experimental`阶段，后续的发展还有很多不确定因素，自己练手玩玩还可以，但是在还没去flag使用之前，尽量不要在生产环境中使用。Node 9.x 更详细`import/export`的使用，可参考 [https://github.com/ChenShenhai/blog/issues/24 (opens new window)](https://github.com/ChenShenhai/blog/issues/24)
