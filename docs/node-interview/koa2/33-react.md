...
# [#](#使用react-js) 使用react.js

## [#](#react-js简介) react.js简介
...
### [#](#react-js执行render渲染) react.js执行render渲染
...
### [#](#静态页面引用react-js编译后文件) 静态页面引用react.js编译后文件
...
![](https://s.poetries.top/uploads/2025/10/9248bd9130920221.png)
