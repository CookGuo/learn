...
### [#](#数据库操作文件-util-db-js) 数据库操作文件 ./util/db.js
...
### [#](#获取所有sql脚本内容-util-get-sql-content-map-js) 获取所有sql脚本内容 ./util/get-sql-content-map.js
...
### [#](#获取sql目录详情-util-get-sql-map-js) 获取sql目录详情 ./util/get-sql-map.js
...
### [#](#遍历目录操作-util-walk-file-js) 遍历目录操作 ./util/walk-file.js
...
### [#](#sql脚本文件-sql-data-sql) sql脚本文件 ./sql/data.sql
...
### [#](#sql脚本文件-sql-user-sql) sql脚本文件 ./sql/user.sql
...
![](https://s.poetries.top/uploads/2025/10/8a5e742faa822e5c.png)

### [#](#查看数据库写入数据) 查看数据库写入数据

![](https://s.poetries.top/uploads/2025/10/8a3348c789f3b2d9.png)
