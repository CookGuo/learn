...
#### [#](#访问连接设置session) 访问连接设置session

[http://localhost:3000/set (opens new window)](http://localhost:3000/set)

![](https://s.poetries.top/uploads/2025/10/91bc12c028d2f606.png)

#### [#](#查看数据库session是否存储) 查看数据库session是否存储

![](https://s.poetries.top/uploads/2025/10/18d92ef45f3917d3.png)

#### [#](#查看cookie中是否种下了sessionid) 查看cookie中是否种下了sessionId

[http://localhost:3000 (opens new window)](http://localhost:3000)

![](https://s.poetries.top/uploads/2025/10/0dcc0383715625ca.png)
