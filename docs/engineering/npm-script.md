...
![](https://s.poetries.top/gitee/2020/07/npm/1.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/2.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/3.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/4.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/5.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/6.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/7.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/8.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/9.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/10.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/11.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/12.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/13.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/14.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/15.png)

同时浏览器会打开覆盖率报告，如下图：

![](https://s.poetries.top/gitee/2020/07/npm/16.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/17.png)

在这个结果里面，我们可以进行类似于 Vim 中的搜索，先按 `/` 进入搜索模式，然后输入 `markdown`，搜索结果如下图：

![](https://s.poetries.top/gitee/2020/07/npm/18.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/19.png)

**2\. 在 npm uninstall 时候根据 package.json 里面的声明给出补全建议**

![](https://s.poetries.top/gitee/2020/07/npm/20.png)

**3\. 在 npm run 时补全建议中列出命令细节**

![](https://s.poetries.top/gitee/2020/07/npm/21.png) ![](https://s.poetries.top/gitee/2020/07/npm/22.png)
...
> **TIP#14**：如果你在编写 `npm script` 过程中有更多的跨平台兼容需求，基本思路是去 [npmjs.com (opens new window)](https://www.npmjs.com/search?q=cross%20platform) 上找对应的包，关键词自然少不了 `cross platform`，你遇到的问题，肯定很多其他人遇到过，相信我，你并不孤独！
...
![](https://s.poetries.top/gitee/2020/07/npm/23.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/24.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/25.png)

读到这里，有没有觉得 `onchange` 可以和 `gulp`、`grunt` 的 `watch` 一样强大。

> 除了上面的单测重跑和代码检查之外，你还有什么需求需要放在 `onchange` 里面
...
![](https://s.poetries.top/gitee/2020/07/npm/26.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/27.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/28.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/29.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/30.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/31.png)

构建完成的 `dist` 目录内容如下：

![](https://s.poetries.top/gitee/2020/07/npm/32.png)

可以看到，所有的静态资源都加上了版本号。

构建完成的 `dist/index.html` 内容如下：

![](https://s.poetries.top/gitee/2020/07/npm/33.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/34.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/35.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/36.png)
...
![](https://s.poetries.top/gitee/2020/07/npm/37.png)
