...
### [#](#_1-存活探针-livenessprobe) 1. 存活探针 LivenessProbe
...
### [#](#_2-可用探针-readinessprobe) 2. 可用探针 ReadinessProbe
...
### [#](#_3-启动探针-startupprobe) 3. 启动探针 StartupProbe
...
![](https://s.poetries.top/images/202202231451715.png)
...
![](https://s.poetries.top/images/202202231451067.png)

> 可以看到，在运行一段时间后，探针被检测失败，Pod 被迫重启，接着创建了新的 Pod。

### [#](#_2-tcpsocketaction) 2. TCPSocketAction
...
### [#](#_3-httpgetaction) 3. HTTPGetAction
...
*   [kubernetes.io/zh/docs/tas… (opens new window)](https://kubernetes.io/zh/docs/tasks/configure-pod-container/configure-liveness-readiness-startup-probes/#define-a-TCP-liveness-probe)
