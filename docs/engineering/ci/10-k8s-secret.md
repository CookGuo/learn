...
![](https://s.poetries.top/images/202202231451005.png)

## [#](#secret-的几种类型) Secret 的几种类型
...
![](https://s.poetries.top/images/202202231451759.png)
...
![](https://s.poetries.top/images/202202231454342.png)
...
![](https://s.poetries.top/images/202202231454392.png)
...
![](https://s.poetries.top/images/202202231454443.png)
...
![](https://s.poetries.top/images/202202231454802.png)
...
![](https://s.poetries.top/images/202202231455843.png)
...
![](https://s.poetries.top/images/202202231455573.png)
...
![](https://s.poetries.top/images/202202231455409.png)

> 第二步：在容器配置配置存储卷。在containers.name\[\]下填写字段 volumeMounts 。这里的 name 值和上面的卷名是对应的。 mountPath 是要挂载到容器内哪个目录，这里代表挂载到用户目录下；readonly 则代表文件是不是只读：
...
![](https://s.poetries.top/images/202202231455662.png)
...
![](https://s.poetries.top/images/202202231455754.png)
...
![](https://s.poetries.top/images/202202231456863.png)
...
![](https://s.poetries.top/images/202202231456847.png)
...
![](https://s.poetries.top/images/202202231456299.png)
...
![](https://s.poetries.top/images/202202231456395.png)
...
![](https://s.poetries.top/images/202202231456972.png)

> 编辑后保存，使用 kubectl apply -f 命令生效配置文件。接着看下 Pod 的运行状态

![](https://s.poetries.top/images/202202231456485.png)
