...
## [#](#一、docker-的四大组成对象) 一、`Docker` 的四大组成对象
...
![](https://s.poetries.top/gitee/2020/07/docker/1.png)
...
### [#](#_2-1-docker-engine-的版本) 2.1 Docker Engine 的版本
...
![](https://s.poetries.top/gitee/2020/07/docker/2.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/3.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/4.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/5.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/6.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/7.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/8.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/9.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/10.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/11.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/12.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/13.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/14.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/15.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/16.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/17.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/18.png)
...
### [#](#_10-3-编写-dockerfile) 10.3 编写 Dockerfile
...
![](https://s.poetries.top/gitee/2020/07/docker/19.png)
...
### [#](#_11-5-搭配-entrypoint-和-cmd) 11.5 搭配 ENTRYPOINT 和 CMD
...
![](https://s.poetries.top/gitee/2020/07/docker/20.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/21.png)

> 另外，我自己也制作了一些软件的镜像，大家可以访问 `GitHub` 上的项目地址，查阅其中的`Dockerfile` 内容：github.com/cogset

## [#](#十二、使用-docker-hub-中的镜像) 十二、使用 Docker Hub 中的镜像

### [#](#_12-1-选择镜像与程序版本) 12.1 选择镜像与程序版本
...
![](https://s.poetries.top/gitee/2020/07/docker/22.png)
...
### [#](#_12-2-alpine-镜像) 12.2 Alpine 镜像
...
![](https://s.poetries.top/gitee/2020/07/docker/23.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/24.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/25.png)

在 `Docker Hub` 中并不直接存放我们用于构建的 `Dockerfile` 和相关文件，我们必须将 `Docker Hub` 账号授权到 `GitHub` 或是 `Bitbucket` 来从这些代码库中获取 `Dockerfile`和相关文件。

![](https://s.poetries.top/gitee/2020/07/docker/26.png)

在连接到 `GitHub` 或 `Bitbucket` 后，我们就可以选择我们存放 `Dockerfile` 和相关文件的代码仓库用来创建自动构建了。

![](https://s.poetries.top/gitee/2020/07/docker/27.png)

在基本信息填写完成，点击创建按钮后，`Docker Hub` 就会开始根据我们 `Dockerfile` 的内容构建镜像了。而此时，我们也能够访问我们镜像专有的详情页面了。

![](https://s.poetries.top/gitee/2020/07/docker/28.png)

## [#](#十三、组合操作-使用-docker-compose-管理容器) 十三、组合操作：使用 Docker Compose 管理容器

### [#](#_13-1-解决容器管理问题) 13.1 解决容器管理问题
...
![](https://s.poetries.top/gitee/2020/07/docker/29.png)
...
### [#](#_13-2-安装-docker-compose) 13.2 安装 Docker Compose
...
### [#](#_13-3-docker-compose-的基本使用逻辑) 13.3 Docker Compose 的基本使用逻辑
...
## [#](#十四、组合操作-常用的-docker-compose-配置项) 十四、组合操作：常用的 Docker Compose 配置项

### [#](#_14-1-定义服务) 14.1 定义服务
...
## [#](#十五、组合操作-编写-docker-compose-项目) 十五、组合操作：编写 Docker Compose 项目

### [#](#_15-1-设计项目的目录结构) 15.1 设计项目的目录结构
...
![](https://s.poetries.top/gitee/2020/07/docker/30.png)
...
### [#](#_15-2-编写-docker-compose-配置文件) 15.2 编写 Docker Compose 配置文件
...
![](https://s.poetries.top/gitee/2020/07/docker/31.png)
...
## [#](#十六、组合操作-应用于服务化开发) 十六、组合操作：应用于服务化开发

### [#](#_16-1-服务开发环境) 16.1 服务开发环境
...
![](https://s.poetries.top/gitee/2020/07/docker/32.png)
...
![](https://s.poetries.top/gitee/2020/07/docker/33.png)
