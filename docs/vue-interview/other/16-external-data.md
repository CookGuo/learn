...
# [#](#开发拓展篇-3-尝试使用外部数据) 开发拓展篇 3：尝试使用外部数据
...
![](https://s.poetries.top/gitee/2020/08/vue/43.png)
...
![](https://s.poetries.top/gitee/2020/08/vue/44.png)

调用接口需要平台提供的 `AppKey`，在你注册登录个人中心的**我的数据**中可以查看对应接口的 `AppKey`：

![](https://s.poetries.top/gitee/2020/08/vue/45.png)

获取到 AppKey 后我们便可以对接口进行测试了，这里我们可以直接通过对应接口的测试按钮进行测试，当然你也可以通过 `postman` 工具进行调试：

![](https://s.poetries.top/gitee/2020/08/vue/46.png)
...
![](https://s.poetries.top/gitee/2020/08/vue/47.png)
