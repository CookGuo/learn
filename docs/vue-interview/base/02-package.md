...
# [#](#构建基础篇-1-你需要了解的包管理工具与配置项) 构建基础篇 1：你需要了解的包管理工具与配置项
...
### [#](#_1-npm-与-package-json) 1. npm 与 package.json
...
![](https://s.poetries.top/gitee/2020/08/vue/7.png)
