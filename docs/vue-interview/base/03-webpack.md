...
# [#](#构建基础篇-2-webpack-在-cli-3-中的应用) 构建基础篇 2：webpack 在 CLI 3 中的应用
...
## [#](#webpack-的使用) webpack 的使用

### [#](#_1-与-vue-cli-2-x-的差异) 1. 与 vue-cli 2.x 的差异
...
![](https://s.poetries.top/gitee/2020/08/vue/8.png)

### [#](#_2-vue-config-js-的配置) 2. vue.config.js 的配置
...
### [#](#c-productionsourcemap) c. productionSourceMap
...
![](https://s.poetries.top/gitee/2020/08/vue/9.png)

### [#](#e-configurewebpack) e. configureWebpack
...
![](https://s.poetries.top/gitee/2020/08/vue/10.png)
