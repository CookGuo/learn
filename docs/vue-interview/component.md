...
![](https://s.poetries.top/gitee/2020/07/vuejs/1.png)
...
![](https://s.poetries.top/gitee/2020/09/115.png)
...
![](https://s.poetries.top/gitee/2020/09/116.png)
...
![](https://s.poetries.top/gitee/2020/07/vuejs/2.png)
...
![](https://s.poetries.top/gitee/2020/09/117.png)
...
> 友情提示：请先阅读 Vue.js 文档的 [https://cn.vuejs.org/v2/guide/forms.html#复选框 (opens new window)](https://cn.vuejs.org/v2/guide/forms.html#%E5%A4%8D%E9%80%89%E6%A1%86) 内容。
...
Checkbox 新增的 prop： `label` 只会在组合使用时有效，结合 `model` 来使用，用法已在 Vue.js 文档中介绍了 [https://cn.vuejs.org/v2/guide/forms.html#复选框 (opens new window)](https://cn.vuejs.org/v2/guide/forms.html#%E5%A4%8D%E9%80%89%E6%A1%86)。
...
## [#](#九、实战-4-全局提示组件-alert) 九、实战 4：全局提示组件——$Alert

> 有一种 Vue.js 组件，它不同于常规的组件，但组件结构本身很简单，比如下面的全局提示组件：

![](https://s.poetries.top/gitee/2020/07/vuejs/3.png)
...
![](https://s.poetries.top/gitee/2020/09/118.png)
...
![](https://s.poetries.top/gitee/2020/07/vuejs/4.png)
...
## [#](#十、更灵活的组件-render-函数与-functional-render) 十、更灵活的组件：Render 函数与 Functional Render
...
![](https://s.poetries.top/gitee/2020/07/vuejs/5.png)
...
2.  对应属性的数据对象，比如组件的 `props`、元素的 `class`、绑定的事件、`slot`、自定义指令等，该参数是可选的，上文所说的 Render 配置项多，指的就是这个参数。该参数的完整配置和示例，可以到 Vue.js 的文档查看，没必要全部记住，用到时查阅就好：[createElement 参数 (opens new window)](https://cn.vuejs.org/v2/guide/render-function.html#createElement-%E5%8F%82%E6%95%B0)。
...
![](https://s.poetries.top/gitee/2020/07/vuejs/6.png)
...
> 您可以阅读 [Vue.js 文档—函数式组件 (opens new window)](https://cn.vuejs.org/v2/guide/render-function.html#%E5%87%BD%E6%95%B0%E5%BC%8F%E7%BB%84%E4%BB%B6) 来查看示例。
...
## [#](#十一、实战-5-可用-render-自定义列的表格组件-table) 十一、实战 5：可用 Render 自定义列的表格组件——Table
...
![](https://s.poetries.top/gitee/2020/07/vuejs/7.png)

因为结构简单，我们甚至不需要组件，直接使用标准的 table 系列标签就可以。但有的时候，除了呈现数据，也会带有一些交互，比如有一列操作栏，可以编辑整行的数据：

![](https://s.poetries.top/gitee/2020/07/vuejs/8.png)
...
![](https://s.poetries.top/gitee/2020/09/119.png)
...
### [#](#使用-render-自定义列模板) 使用 Render 自定义列模板
...
![](https://s.poetries.top/gitee/2020/07/vuejs/9.png)
...
## [#](#十二、实战-6-可用-slot-scope-自定义列的表格组件-table) 十二、实战 6：可用 slot-scope 自定义列的表格组件——Table
...
![](https://s.poetries.top/gitee/2020/07/vuejs/10.png)
...
![](https://s.poetries.top/gitee/2020/07/vuejs/11.png)
...
*   [异步组件 (opens new window)](https://cn.vuejs.org/v2/guide/components-dynamic-async.html#%E5%BC%82%E6%AD%A5%E7%BB%84%E4%BB%B6)

## [#](#十四、实战-7-树形控件-tree) 十四、实战 7：树形控件——Tree
...
![](https://s.poetries.top/gitee/2020/07/vuejs/12.png)
...
## [#](#十五、拓展-vue-js-容易忽略的-api-详解) 十五、拓展：Vue.js 容易忽略的 API 详解
...
## [#](#十六、拓展-vue-js-面试、常见问题答疑) 十六、拓展：Vue.js 面试、常见问题答疑
...
### [#](#计算属性和-watch-的区别) 计算属性和 watch 的区别
...
### [#](#组件中-data-为什么是函数) 组件中 data 为什么是函数

为什么组件中的 data 必须是一个函数，然后 return 一个对象，而 new Vue 实例里，data 可以直接是一个对象？

因为组件是用来复用的，JS 里对象是引用关系，这样作用域没有隔离，而 new Vue 的实例，是不会被复用的，因此不存在引用对象的问题。

### [#](#keep-alive-的理解) keep-alive 的理解

这是个概念题，主要考察候选人是否知道这个用法。简单说，就是把一个组件的编译缓存起来。在第 14 节有过详细介绍，也可以看看 [Vue.js 的文档 (opens new window)](https://cn.vuejs.org/v2/guide/components-dynamic-async.html#%E5%9C%A8%E5%8A%A8%E6%80%81%E7%BB%84%E4%BB%B6%E4%B8%8A%E4%BD%BF%E7%94%A8-keep-alive)。
...
### [#](#自定义组件的语法糖-v-model-是怎样实现的) 自定义组件的语法糖 v-model 是怎样实现的
...
### [#](#vuex-中-mutations-和-actions-的区别) Vuex 中 mutations 和 actions 的区别

> 主要的区别是，actions 可以执行异步。actions 是调用 mutations，而 mutations 来修改 store。

### [#](#render-函数-2) Render 函数
...
[Vue.js 生命周期 (opens new window)](https://cn.vuejs.org/v2/api/#%E9%80%89%E9%A1%B9-%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E9%92%A9%E5%AD%90) 主要有 8 个阶段：
...
### [#](#vue-js-2-x-双向绑定原理) Vue.js 2.x 双向绑定原理
...
### [#](#什么是-mvvm-与-mvc-有什么区别) 什么是 MVVM，与 MVC 有什么区别
