...
# [#](#开发指南篇-1-从编码技巧与规范开始) 开发指南篇 1：从编码技巧与规范开始
...
### [#](#_1-使用对象代替-if-及-switch) 1. 使用对象代替 if 及 switch
...
### [#](#_2-使用-array-from-快速生成数组) 2. 使用 Array.from 快速生成数组
...
### [#](#_3-使用-router-beforeeach-来处理跳转前逻辑) 3. 使用 router.beforeEach 来处理跳转前逻辑
...
### [#](#_4-使用-v-if-来优化页面加载) 4. 使用 v-if 来优化页面加载
...
### [#](#_5-路由跳转尽量使用-name-而不是-path) 5. 路由跳转尽量使用 name 而不是 path
...
### [#](#_6-使用-key-来优化-v-for-循环) 6. 使用 key 来优化 v-for 循环
...
### [#](#_7-使用-computed-代替-watch) 7. 使用 computed 代替 watch
...
### [#](#_9-使用-settimeout-代替-setinterval) 9. 使用 setTimeout 代替 setInterval
...
### [#](#_10-不要使用-for-in-循环来遍历数组) 10. 不要使用 for in 循环来遍历数组
