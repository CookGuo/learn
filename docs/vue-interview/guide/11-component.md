...
# [#](#开发指南篇-3-合理划分容器组件与展示组件) 开发指南篇 3：合理划分容器组件与展示组件
...
![](https://s.poetries.top/gitee/2020/08/vue/27.png)
