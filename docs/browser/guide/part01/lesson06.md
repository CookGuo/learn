...
![](/browser/part01/lesson06/04.png)
...
![](/browser/part01/lesson06/05.png)

出现这种裁剪情况的时候，渲染引擎会为文字部分单独创建一个层，如果出现滚动条，滚动条也会被提升为单独的层。你可以参考下图：

![](/browser/part01/lesson06/06.png)
...
![](/browser/part01/lesson06/09.png)

如上图所示，当图层的绘制列表准备好之后，主线程会把该绘制列表提交（commit）给合成线程，那么接下来合成线程是怎么工作的呢？

那我们得先来看看什么是视口，你可以参看下图：

![](/browser/part01/lesson06/10.png)
...
![](/browser/part01/lesson06/14.png)
...
![](/browser/part01/lesson06/15.png)
...
![](/browser/part01/lesson06/16.png)
...
![](/browser/part01/lesson06/17.png)
