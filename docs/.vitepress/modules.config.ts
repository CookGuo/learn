...
export const modules: ModuleConfig[] = [
  {
    id: 'browser',
    title: '浏览器工作原理',
    description: '系统整理浏览器架构、JavaScript执行机制、V8、页面循环系统、页面与网络',
    icon: '🌐',
    order: 1,
    enabled: true,
    access: 'public',
    ...
    sidebar: [
      {
        text: '宏观视角上的浏览器',
        items: [
          { text: 'Chrome架构：仅仅打开了1个页面，为什么有4个进程', link: '/browser/guide/part01/lesson01' },
          { text: 'TCP协议：如何保证页面文件能被完整送达浏览器', link: '/browser/guide/part01/lesson02' },
          { text: 'HTTP请求流程：为什么很多站点第二次打开速度会很快', link: '/browser/guide/part01/lesson03' },
          { text: '导航流程：从输入URL到页面展示这中间发生了什么', link: '/browser/guide/part01/lesson04' },
          { text: '渲染流程（上）：HTML、CSS和JavaScript是如何变成页面的', link: '/browser/guide/part01/lesson05' },
          { text: '渲染流程（下）：HTML、CSS和JavaScript是如何变成页面的', link: '/browser/guide/part01/lesson06' },
        ],
      },
      {
        text: '浏览器中的JavaScript执行机制',
        items: [
          { text: '变量提升：JavaScript代码是按顺序执行的吗', link: '/browser/guide/part02/lesson07' },
          { text: '调用栈：为什么JavaScript代码会出现栈溢出', link: '/browser/guide/part02/lesson08' },
          { text: '块级作用域：var缺陷以及为什么要引入let和const', link: '/browser/guide/part02/lesson09' },
          { text: '作用域链和闭包：代码中出现相同的变量，JavaScript引擎如何选择', link: '/browser/guide/part02/lesson10' },
          { text: 'this：从JavaScript执行上下文视角讲this', link: '/browser/guide/part02/lesson11' },
        ],
      },
      {
        text: 'V8工作原理',
        items: [
          { text: '栈空间和堆空间：数据是如何存储的', link: '/browser/guide/part03/lesson12' },
          { text: '垃圾回收：垃圾数据如何自动回收', link: '/browser/guide/part03/lesson13' },
          { text: '编译器和解析器：V8如何执行一段JavaScript代码的', link: '/browser/guide/part03/lesson14' },
        ],
      },
      {
        text: '浏览器中的页面循环系统',
        items: [
          { text: '消息队列和事件循环：页面是怎么活起来的', link: '/browser/guide/part04/lesson15' },
          { text: 'Webapi：setTimeout是怎么实现的', link: '/browser/guide/part04/lesson16' },
          { text: 'Webapi：XMLHttpRequest是怎么实现的', link: '/browser/guide/part04/lesson17' },
          { text: '使用Promise告别回调函数', link: '/browser/guide/part04/lesson19' },
          { text: 'async await使用同步方式写异步代码', link: '/browser/guide/part04/lesson20' },
        ],
      },
      {
        text: '浏览器中的页面',
        items: [
          { text: '页面性能分析：利用chrome做web性能分析', link: '/browser/guide/part05/lesson21' },
          { text: 'DOM树：JavaScript是如何影响DOM树构建的', link: '/browser/guide/part05/lesson22' },
          { text: '渲染流水线：CSS如何影响首次加载时的白屏时间？', link: '/browser/guide/part05/lesson23' },
          { text: '分层和合成机制：为什么css动画比JavaScript高效', link: '/browser/guide/part05/lesson24' },
          { text: '页面性能：如何系统优化页面', link: '/browser/guide/part05/lesson25' },
          { text: '虚拟DOM：虚拟DOM和实际DOM有何不同', link: '/browser/guide/part05/lesson26' },
          { text: 'PWA：解决了web应用哪些问题', link: '/browser/guide/part05/lesson27' },
          { text: 'webComponent：像搭积木一样构建web应用', link: '/browser/guide/part05/lesson28' },
        ],
      },
      {
        text: '浏览器中的网络',
        items: [
          { text: 'HTTP1：HTTP性能优化', link: '/browser/guide/part06/lesson29' },
          { text: 'HTTP2：如何提升网络速度', link: '/browser/guide/part06/lesson30' },
          { text: 'HTTP3：甩掉TCP、TCL包袱 构建高效网络', link: '/browser/guide/part06/lesson31' },
          { text: '同源策略：为什么XMLHttpRequst不能跨域请求资源', link: '/browser/guide/part06/lesson32' },
          { text: '跨站脚本攻击XSS：为什么cookie中有httpOnly属性', link: '/browser/guide/part06/lesson33' },
          { text: 'CSRF攻击：陌生链接不要随便点', link: '/browser/guide/part06/lesson34' },
          { text: '沙盒：页面和系统之间的隔离墙', link: '/browser/guide/part06/lesson35' },
          { text: 'HTTPS：让数据传输更安全', link: '/browser/guide/part06/lesson36' },
        ],
      },
    ],
  },
