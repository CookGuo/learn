...
## [#](#二-实践一-自动上报pv-click的埋点hooks-uselog) 二 实践一：自动上报pv/click的埋点hooks—— useLog
...
![4.gif](https://s.poetries.top/md/9a1a6243523d4b0388d8bc64a1a0b9bc~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

## [#](#三-实践二-带查询的分页加载长列表-usequerytable) 三 实践二：带查询的分页加载长列表—— useQueryTable
...
![5.jpg](https://s.poetries.top/md/213c059f312e45e8bb670602c11bf183~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![6.gif](https://s.poetries.top/md/636f36676b3f434d84136043fe97002c~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
## [#](#四-实践三-实现react-redux功能-usecreatestore-useconnect) 四 实践三：实现React-Redux功能—— useCreateStore | useConnect
...
#### [#](#usecreatestore-设计) useCreateStore 设计
...
![7.jpg](https://s.poetries.top/md/365036e1c9f44c648f6203b9b950c736~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

### [#](#_2-usecreatestore) 2 useCreateStore
...
### [#](#_3-状态管理者-reduxhooksstore) 3 状态管理者 —— ReduxHooksStore
...
*   `publicRender`：当 state 改变需要通知每一个使用 useConnect 的组件，这个方法就是通知更新，至于组件需不需要更新，那是 useConnect 内部需要处理的事情，这里还有一个细节，就是考虑到 dispatch 的触发场景可以是异步状态下，所以用 React-DOM 中 unstable\_batchedUpdates 开启批量更新原则。

### [#](#_4-useconnect) 4 useConnect
...
### [#](#_5-使用与验证效果) 5 使用与验证效果

接下来就是验证效果环节，我模拟了组件通信的场景。

#### [#](#根部组件注入-store) 根部组件注入 Store
...
![8.gif](https://s.poetries.top/md/f7b06820f28f461c91620d7240b63ed5~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
