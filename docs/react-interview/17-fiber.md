---
title: 原理篇 调和与 fiber|React进阶专题 | 前端进阶学习
source: https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/17-原理篇%20调和与%20fiber.html
crawled: 2026-04-09
---

# 原理篇 调和与 fiber|React进阶专题 | 前端进阶学习

> 原文: [https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/17-原理篇%20调和与%20fiber.html](https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/17-原理篇%20调和与%20fiber.html)
...
## [#](#二-全面认识fiber) 二 全面认识Fiber

### [#](#_1-element-fiber-dom三种什么关系) 1 element,fiber,dom三种什么关系？
...
![2.jpg](https://s.poetries.top/md/0a90368f24f0477aaf0d446a8f6736db~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
### [#](#_2-fiber保存了那些信息) 2 fiber保存了那些信息
...
### [#](#_3-每一个fiber如何建立起关联的) 3 每一个fiber如何建立起关联的
...
![](https://s.poetries.top/cos/202203251651873.png)

## [#](#三-fiber更新机制) 三 Fiber更新机制
...
![3.jpg](https://s.poetries.top/md/cb68640d39914c03bc77ea15616c7918~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![4.jpg](https://s.poetries.top/md/9a7f5a9b77ff45febd8e255fcba1ba3a~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![5.jpg](https://s.poetries.top/md/cda0522c0c85435494ccf3a3ea587baa~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

最后会以 workInProgress 作为最新的渲染树，fiberRoot 的 current 指针指向 workInProgress 使其变为 current Fiber 树。到此完成初始化流程。

效果：

![6.jpg](https://s.poetries.top/md/907fb4f6768842438e0df7f083adc4b6~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![7.jpg](https://s.poetries.top/md/ff00ce5f2db0430c841ea3a01754542e~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

**｜--------问与答--------｜** 问：如果如上又发生一次点击，会发生什么？
...
#### [#](#向上归并-completeunitofwork) 向上归并 completeUnitOfWork
...
#### [#](#_1-before-mutation) ① Before mutation
...
### [#](#_3-调和-异步调度-流程总图) 3 调和 + 异步调度 流程总图

把上一章节和本章节串联起来，调和调度过程，如下图所示：

![3.jpeg](https://s.poetries.top/md/429a103a732e42b69b6cd9a32f1d265a~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
