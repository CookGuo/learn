---
title: 实践篇 自定义弹窗|React进阶专题 | 前端进阶学习
source: https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/25-实践篇%20自定义弹窗.html
crawled: 2026-04-09
---

# 实践篇 自定义弹窗|React进阶专题 | 前端进阶学习

> 原文: [https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/25-实践篇%20自定义弹窗.html](https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/25-实践篇%20自定义弹窗.html)
...
#### [#](#_3-不依赖父组件实现挂载-卸载组件) 3 不依赖父组件实现挂载/卸载组件
...
#### [#](#modal-分配-props-渲染视图) Modal——分配 props ，渲染视图
...
![3.jpg](https://s.poetries.top/md/b6178f43140c487892a4a42e5d6c62b2~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

关闭弹窗流程图：

![4.jpg](https://s.poetries.top/md/8f9a9f513989494294bfb9e6209f0c62~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

## [#](#四-验证环节) 四 验证环节

### [#](#验证第一种-通过挂载组件方式) 验证第一种——通过挂载组件方式
...
![1.gif](https://s.poetries.top/md/b19d0ca825aa496e9aa4faf2b7056616~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

### [#](#验证第二种-通过静态属性方式) 验证第二种——通过静态属性方式
...
![2.gif](https://s.poetries.top/md/9a81ecfe551e4907bc551b820cd0f007~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
