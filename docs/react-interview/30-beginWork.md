---
title: 原理篇 beginWork和render全流程|React进阶专题 | 前端进阶学习
source: https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/30-原理篇%20beginWork和render全流程.html
crawled: 2026-04-09
---

# 原理篇 beginWork和render全流程|React进阶专题 | 前端进阶学习

> 原文: [https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/30-原理篇%20beginWork和render全流程.html](https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/30-原理篇%20beginWork和render全流程.html)
...
## [#](#二-state-更新源泉) 二 state 更新源泉

### [#](#_1-更新的最小单元) 1 更新的最小单元
...
### [#](#_2-beginwork-更新源泉) 2 beginWork 更新源泉
...
## [#](#三-起源-从-state-改变到-scheduleupdateonfiber) 三 起源: 从 state 改变到 scheduleUpdateOnFiber
...
### [#](#_1-scheduleupdateonfiber-开始更新-fiber) 1 scheduleUpdateOnFiber 开始更新 fiber
...
![1.jpg](https://s.poetries.top/md/2421bbf350134d438f1bdc12b2882974~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?) 上面描述了整个 fiber 树调和流程。
...
![2.jpg](https://s.poetries.top/md/c8710f7ad77f44ecb97cd6200c4a5b76~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)

## [#](#四-探索-从-workloop-到-beginwork) 四 探索：从 workLoop 到 beginWork
...
![4.jpg](https://s.poetries.top/md/46a8441e883f4d70a39e5e56b58d6ff9~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)
...
![5.jpg](https://s.poetries.top/md/37a14aa23434495aba1b9dfb985ff219~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)

*   场景二：**当更新 B 组件**，那么组件 A fiber 会被标记，然后 A 会调和，但是不会 rerender；组件 B 是当事人，既会进入调和，也会 rerender；组件 C 受到父组件 B 的影响，会 rerender。

![6.jpg](https://s.poetries.top/md/e21e929037b04614897e20338752f324~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)

*   场景三；**当更新 C组件**，那么 A，B 会进入调和流程，但是不会 rerender，C 是当事人，会调和并 rerender。

![7.jpg](https://s.poetries.top/md/3691b87d164a427b8c7a180e53b6d84d~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)

那么如上的场景本质上都在 **`beginWork`** 中进行的，这个 beginWork 是如何处理这些逻辑的。

## [#](#五-揭秘-从-beginwork-到组件更新全流程) 五 揭秘：从 beginWork 到组件更新全流程

接下来从 beginWork 开始，重点研究一下流程。

### [#](#_1-beginwork-更新的调度站) 1 beginWork 更新的调度站
...
![8.jpg](https://s.poetries.top/md/d8a6957eadb24a92992c33aae021815c~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)
...
![9.jpg](https://s.poetries.top/md/9d8b4c1d668d47778b52e3c2c5bc843f~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)

**场景三**：当更新 C 时候，那么 A 和 B 组件会标记 childLanes，所以 A 和 B 会被调和，但是不会更新，然后到 C ，C 会走正常流程。

![10.jpg](https://s.poetries.top/md/8d1bfffd917d4e458c6544ee9aa1ff55~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)

**场景四**：还有一种情况，什么时候 B 会跳出调和流程呢。

![11.jpg](https://s.poetries.top/md/eaf97e258da4462c8b5ddf85a284e2ca~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)

到此为止完成了整个更新流程。

### [#](#_5-beginwork-流程图) 5 beginWork 流程图

![3.jpg](https://s.poetries.top/md/99afa68f8ab94c93be41df70db0ae488~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)
