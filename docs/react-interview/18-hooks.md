---
title: 原理篇 Hooks 原理|React进阶专题 | 前端进阶学习
source: https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/18-原理篇%20Hooks%20原理.html
crawled: 2026-04-09
---

# 原理篇 Hooks 原理|React进阶专题 | 前端进阶学习

> 原文: [https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/18-原理篇%20Hooks%20原理.html](https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/18-原理篇%20Hooks%20原理.html)
...
## [#](#二-hooks与fiber-workinprogress) 二 hooks与fiber（workInProgress）
...
![hook1.jpg](https://s.poetries.top/md/05d76f28b43d41168ff25e6310c61e96~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
### [#](#hooks初始化-hooks-如何和-fiber-建立起关系) hooks初始化- hooks 如何和 fiber 建立起关系
...
![hook2.jpg](https://s.poetries.top/md/b589f284235c477e9e987460862cc5ef~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![hook3.jpeg](https://s.poetries.top/md/e3a10b8466324fa89cf2bc5903b29618~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)

第二次复用时候已经发现 hooks 类型不同 `useState !== useRef` ，那么已经直接报错了。所以开发的时候一定注意 hooks 顺序一致性。

报错内容：

![hookk4.jpg](https://s.poetries.top/md/b5a0be8080fb462dad4fe024f030a205~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![hook5.jpg](https://s.poetries.top/md/750ee5e50ff8494791f52bd095b305ca~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![hook6.jpg](https://s.poetries.top/md/21485f1321864045a73bca1b3afdc948~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
## [#](#五-状态获取与状态缓存) 五 状态获取与状态缓存

### [#](#_1-对于-ref-处理) 1 对于 ref 处理
...
### [#](#_2-对于usememo的处理) 2 对于useMemo的处理
