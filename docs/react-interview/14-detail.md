...
![1.gif](https://s.poetries.top/md/390bc5aad3454d86a8b6c0b3a2d22b1a~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![2.gif](https://s.poetries.top/md/58d282f3433b4552bdba0e6e1487acc7~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![pre](https://s.poetries.top/md/eb283e44fe0746de93d17f45fdcc1ccb~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![after](https://s.poetries.top/md/2f3909bdcdd24d769478d7f8929dcd3b~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

### [#](#_3-react动画) 3 React动画
...
![3.gif](https://s.poetries.top/md/4bfef6017c0844e4abea4a79b5ad8db1~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

这种方式是我最优先推荐的方式，这种方式既不需要频繁 setState ，也不需要改变 DOM 。

#### [#](#_2-其次-操纵原生-dom) ② 其次：操纵原生 DOM
...
#### [#](#_3-再者-setstate-css3) ③ 再者：setState + css3
...
![4.gif](https://s.poetries.top/md/134a3683658d4440932b8aeccd55591d~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

### [#](#_4-及时清除定时器-延时器-监听器) 4 及时清除定时器/延时器/监听器
...
### [#](#_6-建议不要在-hooks-的参数中执行函数或者-new-实例) 6 建议不要在 hooks 的参数中执行函数或者 new 实例
