---
title: 基础篇 高阶组件|React进阶专题 | 前端进阶学习
source: https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/10-基础篇%20高阶组件.html
crawled: 2026-04-09
---

# 基础篇 高阶组件|React进阶专题 | 前端进阶学习

> 原文: [https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/10-基础篇%20高阶组件.html](https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/10-基础篇%20高阶组件.html)
...
## [#](#二高阶组件基本介绍-能解决什么问题) 二高阶组件基本介绍-能解决什么问题？

### [#](#_1-高阶组件能解决什么问题) 1 高阶组件能解决什么问题

高级组件到底能够解决什么问题？举一个特别简单的例子，话说小明负责开发一个 web 应用，应用的结构如下所示，而且这个功能小明已经开发完了。

![hoc2.jpg](https://s.poetries.top/md/c4effb7bd6764e80ab0e7c25e177d56e~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

但是，有一天老板突然提出了一个权限隔离的需求，就是部分模块组件受到权限控制，后台的数据交互的结果权限控制着模块展示与否，而且没有权限会默认展示无权限提示页面。（如下图，黄色部分是受到权限控制的组件模块）

![hoc3.jpg](https://s.poetries.top/md/79bc49c43520456182a88610b8eb3f1e~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

那么小明面临的问题是，如何给需要权限隔离的模块，绑定权限呢？那第一种思路是把所有的需要权限隔离的模块重新绑定权限，通过权限来判断组件是否展示。

![hoc4.jpg](https://s.poetries.top/md/3f02c232062048cb88f1c39e8afc7862~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![hoc5.jpg](https://s.poetries.top/md/aa0f9b5e798947c9aa563c7213ef7b87~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![hoc6.jpg](https://s.poetries.top/md/97a76447f740458f91982e4038e46d2e~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
## [#](#三-高阶组件功能说明-如何编写高阶组件) 三 高阶组件功能说明-如何编写高阶组件？

### [#](#_1-强化props) 1 强化props
...
![40D6BF30-9B4C-4EC9-B089-1E757DAC15DF.jpg](https://s.poetries.top/md/8768ee8201e949d8a7c2f7c0ec72b1e4~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![](https://s.poetries.top/cos/202203300917918.png)
...
## [#](#四-高价组件注意事项) 四 高价组件注意事项

### [#](#_1-谨慎修改原型链) 1 谨慎修改原型链
...
### [#](#_2-不要在函数组件内部或类组件render函数中使用hoc) 2 不要在函数组件内部或类组件render函数中使用HOC
...
### [#](#_4-注意多个hoc嵌套顺序问题) 4 注意多个HOC嵌套顺序问题
...
![hoc1.jpg](https://s.poetries.top/md/553a203098134c5abf734f4104ab4d14~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
## [#](#五-进阶实践-权限拦截) 五 进阶实践-权限拦截

下面解决刚开始小明遇到的权限拦截问题。具体可以参考如下 demo ，没有绑定效果如下：

![hoc6.gif](https://s.poetries.top/md/d07a81733e1344d4b4773934cd0f19d4~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![hoc7.gif](https://s.poetries.top/md/469ab81641774cf0943445f801522c9f~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
