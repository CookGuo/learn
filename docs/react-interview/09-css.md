...
![css1.jpg](https://s.poetries.top/md/ba20e19cfa264079978bc174f5bf0cb9~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

**首先来看看样式类名被编译成什么？**

![css2.jpg](https://s.poetries.top/md/648418b349f24fcdb0060bbc1e924521~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

如上，可以看到 css-loader 将 text 变成了全局唯一的类名 `_1WHQzhI7PwBzQ_NMib7jy6`。这样有效的避免了样式冲突，全局类名污染的情况。

### [#](#_1-自定义命名规则) 1 自定义命名规则
...
![css3.jpg](https://s.poetries.top/md/c6bbab9c02794fa5bee0cd6750df3a4d~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

此时类名变成了， `src-pages-cssModule-style__text--1WHQz`，这个命名规则意义如下

*   **\[path\]\[name\]\_\_\[local\]** -> 开发环境，便于调试。可以直接通过 `src-pages-cssModule-style` 找到此类名对应的文件。
...
![css4.jpg](https://s.poetries.top/md/008d9a0e59a14ace8d129298f07643b2~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
### [#](#_4-配置-less-和-sass) 4 配置 less 和 sass
...
![css5.jpg](https://s.poetries.top/md/eac65e125ce54000a8de4592e7860b74~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![css6.jpg](https://s.poetries.top/md/4de2995a9a334dfdad36ec60fa779c18~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

### [#](#_6-动态添加class) 6 动态添加class
...
![css11.gif](https://s.poetries.top/md/75d835f79b3f4ebb8b3d5548fa2c3968~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

通过 CSS Modules 配合 classNames 灵活的实现了样式的动态加载。

### [#](#_7-css-modules-总结) 7 CSS Modules 总结
...
![css7.jpg](https://s.poetries.top/md/aab5054688f144ec9ed4f9bbb41cc08a~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
### [#](#_3-style-components库使用) 3 style-components库使用
...
![css8.jpg](https://s.poetries.top/md/48fe19e6059e4cfeb5ada8118b620996~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![css9.jpg](https://s.poetries.top/md/4b091e38138649299c1cf4c65cfa37e8~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![css10.jpg](https://s.poetries.top/md/48cf0accb8dd4292a39b01c10a476673~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

style-components 还有一些其他的功能，这里我就不一一介绍了，感兴趣的同学可以了解一下官网。[styled-components (opens new window)](https://link.juejin.cn/?target=https%3A%2F%2Fstyled-components.com%2Fdocs%2Fbasics%23extending-styles)

### [#](#_4-css-in-js-总结) 4 CSS IN JS 总结
