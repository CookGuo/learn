...
## [#](#四-index文件及其他组件) 四 Index文件及其他组件
...
![fail.gif](https://s.poetries.top/md/e64e5028369f4e2ea0d93d8007d0d842~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

调用 submit ，验证失败的情况。

**② 表单验证通过**

![success.gif](https://s.poetries.top/md/200b9221b3a7444b85b11a71276f7680~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

验证成功！

**③ 获取表单的数据层**

![get.gif](https://s.poetries.top/md/a708afa9565b427ab545a7890d910e09~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

通过 getFieldsValue 获取表单数据层。

**④ 重置表单的数据层**

![reset.gif](https://s.poetries.top/md/d22e76ea1f0e4cde9ee2eb01013855f3~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

通过 resetFields 重置表单。

**⑤ 动态添加表单验证规则**

![dongtai.gif](https://s.poetries.top/md/14e6d60035764c06b66a9eb877d5b1e8~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
