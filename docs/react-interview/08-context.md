---
title: 基础篇 提供者 context|React进阶专题 | 前端进阶学习
source: https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/08-基础篇%20提供者%20context.html
crawled: 2026-04-09
---

# 基础篇 提供者 context|React进阶专题 | 前端进阶学习

> 原文: [https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/08-基础篇%20提供者%20context.html](https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/08-基础篇%20提供者%20context.html)
...
![context1.jpg](https://s.poetries.top/md/198d518f80e7429880fdc99d6adab9de~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![context2.jpg](https://s.poetries.top/md/4beb4f01370a427dbc3a040c101b7664~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
## [#](#二-新版本-context-基本使用) 二 新版本 context 基本使用
...
### [#](#_1-createcontext) 1 createContext
...
#### [#](#_1-类组件之contexttype-方式) ① 类组件之contextType 方式
...
#### [#](#_2-函数组件之-usecontext-方式) ② 函数组件之 useContext 方式
...
#### [#](#_3-订阅者之-consumer-方式) ③ 订阅者之 Consumer 方式
...
![context5.gif](https://s.poetries.top/md/44823e8cb2e649afb33f3b121d11ada8~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
**｜--------问与答---------｜** **问**：context 与 props 和 react-redux 的对比？
...
![context3.jpg](https://s.poetries.top/md/ccff7c88313d4b4babc391cff29958cb~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![context4.jpg](https://s.poetries.top/md/34b61485cea445b48b5b40d0fa4ab25f~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
## [#](#四-进阶实践-切换主题模式) 四 进阶实践-切换主题模式

接下来实践用 Provider Api 实现一个切换 主题颜色的 demo 。

**实现效果**

![context6.gif](https://s.poetries.top/md/1cd88a1ed1fd4999ac5cf91e65bded9b~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
