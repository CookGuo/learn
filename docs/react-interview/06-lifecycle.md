---
title: 基础篇 理解 lifeCycle|React进阶专题 | 前端进阶学习
source: https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/06-基础篇%20理解%20lifeCycle.html
crawled: 2026-04-09
---

# 基础篇 理解 lifeCycle|React进阶专题 | 前端进阶学习

> 原文: [https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/06-基础篇%20理解%20lifeCycle.html](https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/06-基础篇%20理解%20lifeCycle.html)
...
![lifecycle3.jpg](https://s.poetries.top/md/018a9cbd20df478a955b84beba770674~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![lifesycle4.jpg](https://s.poetries.top/md/9838872f404c474b87612400c3a6c504~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![lifecycle5.jpg](https://s.poetries.top/md/de17c24547b040b9a93b01706d9e585b~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![lifecycle6.jpg](https://s.poetries.top/md/37d76e8437764f2fb605c03332d5fb0f~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

三个阶段生命周期+无状态组件总览图：

![lifesycyle8.jpg](https://s.poetries.top/md/7066da719fda4a91aa2c432f60c58a48~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

### [#](#react-各阶段生命周期能做些什么) React 各阶段生命周期能做些什么

上面部分详细的介绍了 React 各生命周期的执行时机和执行顺序。接下来分别介绍一下各个 lifecycle 能做些什么？

#### [#](#_1-constructor) 1 constructor
...
#### [#](#_2-getderivedstatefromprops) 2 getDerivedStateFromProps
...
#### [#](#_3-componentwillmount-和-unsafe-componentwillmount) 3 componentWillMount 和 UNSAFE\_componentWillMount
...
#### [#](#_4-componentwillreceiveprops-和-unsafe-componentwillreceiveprops) 4 componentWillReceiveProps 和 UNSAFE\_componentWillReceiveProps
...
#### [#](#_5-componentwillupdate-和-unsafe-componentwillupdate) 5 componentWillUpdate 和 UNSAFE\_componentWillUpdate
...
#### [#](#_7-getsnapshotbeforeupdate) 7 getSnapshotBeforeUpdate
...
#### [#](#_8-componentdidupdate) 8 componentDidUpdate
...
#### [#](#_9-componentdidmount) 9 componentDidMount
...
#### [#](#_10-shouldcomponentupdate) 10 shouldComponentUpdate
...
#### [#](#_11-componentwillunmount) 11 componentWillUnmount
...
## [#](#_3-函数组件生命周期替代方案) 3 函数组件生命周期替代方案

React hooks也提供了 api ，用于弥补函数组件没有生命周期的缺陷。其原理主要是运用了 hooks 里面的 `useEffect` 和 `useLayoutEffect`。

### [#](#_1-useeffect-和-uselayouteffect) 1 useEffect 和 useLayoutEffect
...
### [#](#_2-componentdidmount-替代方案) 2 componentDidMount 替代方案
...
### [#](#_3-componentwillunmount-替代方案) 3 componentWillUnmount 替代方案
...
### [#](#_4-componentwillreceiveprops-代替方案) 4 componentWillReceiveProps 代替方案
...
### [#](#_5-componentdidupdate-替代方案) 5 componentDidUpdate 替代方案
...
![lifecycle.gif](https://s.poetries.top/md/a45e5260796b424fa1bd2d7bbce19d4b~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

## [#](#四-实践-实现一个scrollview组件) 四 实践-实现一个ScrollView组件
...
![lifecycle2.gif](https://s.poetries.top/md/c4139eb69f014d08abd8a64d6aab4d77~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
