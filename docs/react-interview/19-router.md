...
![spa.jpg](https://s.poetries.top/md/840f7293a6fd479eb4c88e2e2f3f5ae5~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

## [#](#二-路由原理) 二 路由原理

单页面路由实现方式，一直是前端面试容易提问的点之一，从路由实现到深入路由原理，都是需要必要掌握的知识，所以有必要先来探讨一下路由原理。

### [#](#_1-history-react-router-react-router-dom-三者关系) 1 history ,React-router , React-router-dom 三者关系

弄清楚 Router 原理之前，用一幅图表示 History ，React-Router ， React-Router-Dom 三者的关系。这对下面的系统学习很重要。

![three.jpg](https://s.poetries.top/md/7ff05efcf1d04fefaa4c2b94d09827bd~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
## [#](#三-react-router-基本构成) 三 React-Router 基本构成

### [#](#_1-history-location-match) 1 history，location，match
...
![twoofrouter.jpg](https://s.poetries.top/md/49d8c80ea16d4ff59b51412559942cf6~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![routeList.gif](https://s.poetries.top/md/69690111f6c84d88aa6418eb7d26e6af~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
### [#](#_3-从路由改变到页面跳转流程图) 3 从路由改变到页面跳转流程图

我用一幅图描述当用户触发 history.push ，或者点击浏览器前进后退，路由改变到页面重新渲染流程。

![zong.jpg](https://s.poetries.top/md/05eddc3893034f4a99d4874ef8cebfc3~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
#### [#](#_3-usehistory-和-uselocation) ③ useHistory 和 useLocation
...
![success.gif](https://s.poetries.top/md/4b1a4875dbcc472f93d1c2cc97989c3d~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

## [#](#六-总结) 六 总结

本章节从路由原理，路由内部构成和分工，路由使用指南，路由实践-权限路由四个模块系统的学习了 React-Router 。

对于 history 部分的源码和原理，我没有具体分析，感兴趣的同学可以看源码解析系列。

[「源码解析 」这一次彻底弄懂react-router路由原理 (opens new window)](https://juejin.cn/post/6886290490640039943)
