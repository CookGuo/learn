---
title: React 18特性篇 concurrent 下的 state更新流程|React进阶专题 | 前端进阶学习
source: https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/34-v18特性篇%20concurrent%20下的%20state更新流程.html
crawled: 2026-04-09
---

# React 18特性篇 concurrent 下的 state更新流程|React进阶专题 | 前端进阶学习

> 原文: [https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/34-v18特性篇%20concurrent%20下的%20state更新流程.html](https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/34-v18特性篇%20concurrent%20下的%20state更新流程.html)
...
## [#](#二-主流框架中更新处理方式) 二 主流框架中更新处理方式

在正式讲解 v18 concurrent 之前，先来看一下主流框架中两种批量更新的原理。

### [#](#_1-第一种-微任务-宏任务实现集中更新) 1 第一种：微任务｜宏任务实现集中更新
...
![4.jpeg](https://s.poetries.top/md/820a397dc96e4b66a90ad74251bb02e6~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)
...
![3.jpeg](https://s.poetries.top/md/115940d55be44d4797403c97b43b5f46~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)

### [#](#_2-第二种-可控任务实现批量更新) 2 第二种：可控任务实现批量更新
...
![5.jpeg](https://s.poetries.top/md/0ea25cbafb4e4d6ebdfb0bf1531c3e82~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)
...
![6.jpg](https://s.poetries.top/md/c070f19898a84b0f8225c1b67f1db74d~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)
...
## [#](#三-与传统-legacy-模式的区别) 三 与传统 legacy 模式的区别
...
### [#](#一次更新-state-会发生什么) 一次更新 state 会发生什么？
...
![7.jpg](https://s.poetries.top/md/ce67eb14209a4fb8846ce4e50aa29fe0~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)

*   点击按钮 `异步环境下`，组件会渲染二次。相信读过之前章节的同学，都明白原理是什么，在异步条件下的更新任务，不在 React 可控的范围内，所以会触发两次流程。

![8.jpg](https://s.poetries.top/md/6f4d7fcc26b84a65a3d1b2a669b09639~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)

**重点来了，我们看一下 v18 concurrent 下更新：**

*   无论点击 **`同步环境下`** 还是 **`异步环境下`** ，组件都会执行一次。

![7.jpg](https://s.poetries.top/md/35d739049bff4e7ab6f72c48b8a83d09~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)

首先想一下，在 concurrent 下，如何实现更新合并的呢？

## [#](#四-v18-更新原理揭秘) 四 v18 更新原理揭秘
...
![9.jpg](https://s.poetries.top/md/6b05ae38731f4104a84b70b6ca5d49a9~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)
