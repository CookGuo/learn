---
title: 优化篇 渲染控制|React进阶专题 | 前端进阶学习
source: https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/11-优化篇%20渲染控制.html
crawled: 2026-04-09
---

# 优化篇 渲染控制|React进阶专题 | 前端进阶学习

> 原文: [https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/11-优化篇%20渲染控制.html](https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/11-优化篇%20渲染控制.html)
...
## [#](#三-react-几种控制-render-方法) 三 React 几种控制 render 方法
...
### [#](#_1-缓存react-element对象) 1 缓存React.element对象
...
![1.gif](https://s.poetries.top/md/99e32bcd5b1344ea9654001fb56917c0~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![2.gif](https://s.poetries.top/md/c60e3744029f45d3a6ef8a324c0e0327~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
### [#](#_2-purecomponent) 2 PureComponent
...
![](https://s.poetries.top/cos/202203251643987.png)
...
### [#](#_3-shouldcomponentupdate) 3 shouldComponentUpdate
...
![](https://s.poetries.top/cos/202203251644058.png)
...
![](https://s.poetries.top/cos/202203251644367.png)
...
### [#](#_6-渲染控制流程图) 6 渲染控制流程图

![5.jpg](https://s.poetries.top/md/3df03000a39549bead3c84750c62576c~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

## [#](#四-对于render的思考) 四 对于render的思考

### [#](#_1-有没有必要在乎组件不必要渲染。) 1 有没有必要在乎组件不必要渲染。
...
### [#](#_2-什么时候需要注意渲染节流。) 2 什么时候需要注意渲染节流。
