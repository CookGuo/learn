---
title: 生态篇 React mobx|React进阶专题 | 前端进阶学习
source: https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/21-生态篇%20React%20mobx.html
crawled: 2026-04-09
---

# 生态篇 React mobx|React进阶专题 | 前端进阶学习

> 原文: [https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/21-生态篇%20React%20mobx.html](https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/21-生态篇%20React%20mobx.html)
...
![2.jpg](https://s.poetries.top/md/1268c78788bd436887d91d9d997b680a~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
#### [#](#mobx-react-常用-api) mobx-react 常用 api
...
![1.gif](https://s.poetries.top/md/7b80f4d277744fe6999e214f036d97fb~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

## [#](#四-mobx流程分析和原理揭秘) 四 Mobx流程分析和原理揭秘
...
#### [#](#_1绑定状态-observable) ①绑定状态——observable
...
#### [#](#_2激活状态-makeobservable) ②激活状态——makeObservable
...
#### [#](#_3观察者属性管理者-observableadministration) ③观察者属性管理者——ObservableAdministration
...
![3.jpg](https://s.poetries.top/md/b46e88e4ac7c4a24a61c4e9bc56617e8~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

### [#](#_2-依赖收集) 2 依赖收集

如上详细介绍了初始化过程，接下来一起研究一下依赖收集流程。通过初始化过程，还遗留一点就是 ObservableValue 做了哪些事？

#### [#](#_1观察者-observablevalue) ①观察者——ObservableValue
...
#### [#](#_2注入模块-provider和inject-mobx-react) ②注入模块——Provider和inject（mobx-react）
...
#### [#](#_3可观察组件-observer-mobx-react) ③可观察组件—— observer（ mobx-react ）
...
① 对于有**当前 Reaction**的 observableValue，observableValue会统一删除掉里面的 Reaction。 ② 会给这一次 render 中用到的新的依赖 observableValue ，统一添加当前的 Reaction 。 ③ 还会有一些细节，比如说在 render 中，引入两次相同的值（如上的 demo 中的 name ），会统一收集一次依赖。

依赖收集流程图：

![4.jpeg](https://s.poetries.top/md/5712e9017d4946fbac0876ddf2542e6c~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![5.jpeg](https://s.poetries.top/md/606265172f9649e59b16c783923f4dd4~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

## [#](#五-mobx与redux区别) 五 Mobx与Redux区别
