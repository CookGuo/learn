---
title: 原理篇 Context原理|React进阶专题 | 前端进阶学习
source: https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/29-原理篇%20Context原理.html
crawled: 2026-04-09
---

# 原理篇 Context原理|React进阶专题 | 前端进阶学习

> 原文: [https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/29-原理篇%20Context原理.html](https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/29-原理篇%20Context原理.html)
...
*   2 为什么对于 class 类组件会创建一个 ForceUpdate 类型的 update 对象呢？ 知其然，知其所以然，首先看一下它是什么？
...
1 有 `contextType` 静态属性指向的类组件。 2 使用 `useContext` hooks 的函数组件。 3 context 提供的 `Consumer`。
...
![context7.jpg](https://s.poetries.top/md/6ad02d5d2b0640ca8d376abebff714a2~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)

**第三个问题：** 这个问题就要从 Provider 类型的 fiber 调和开始讲。

#### [#](#provider-和-beiginwork-调和更新机制) Provider 和 beiginWork 调和更新机制
...
![context8.jpg](https://s.poetries.top/md/4be69acfeb8d42c68249f96b8bbb7b98~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)
...
![context9.jpg](https://s.poetries.top/md/76bac2d4e134455dbdf31fa33cd7f27b~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)
...
![context10.jpg](https://s.poetries.top/md/015b6ad8e1404fae88319b150cd05451~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)
...
![context11.jpg](https://s.poetries.top/md/84210209b512493889a9d2c3a066324e~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)

那么整个 fiber 更新流程会像如下一样

![context12.jpg](https://s.poetries.top/md/761505beb9664b09a27599550b6a0cf7~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png?)

### [#](#_2-consumer) 2 Consumer

我们已经讲了 Provider 核心原理，还有另外一部分就是 Consumer ，研究一下其原理。

#### [#](#consumer-流程) Consumer 流程
...
#### [#](#多个-provider-嵌套) 多个 Provider 嵌套

如果有多个 Provider 的情况，那么后一个 contextValue 会覆盖前一个 contextValue，在开发者脑海中，要有一个定律就是：**`Provider` 是用来传递 value，而非保存 value 。**

### [#](#_3-contexttype-和-usecontext) 3 contextType 和 useContext

#### [#](#usecontext-原理) useContext 原理
...
### [#](#_4-context-流程总结) 4 Context 流程总结
