---
title: 基础篇 深入 props|React进阶专题 | 前端进阶学习
source: https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/05-基础篇%20深入%20props.html
crawled: 2026-04-09
---

# 基础篇 深入 props|React进阶专题 | 前端进阶学习

> 原文: [https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/05-基础篇%20深入%20props.html](https://interview.poetries.top/fe-improve-docs/react/react-improve/docs/05-基础篇%20深入%20props.html)
...
![prop1.jpg](https://s.poetries.top/md/ebdf41b5a514461da1c30342db1d8fce~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

在标签内部的属性和方法会直接绑定在 props 对象的属性上，对于组件的插槽会被绑定在 props 的 Children 属性中。

### [#](#_2-react如何定义的props) 2 React如何定义的props？
...
### [#](#_4-props-children模式) 4 props children模式
...
![comp3.jpg](https://s.poetries.top/md/78abb0c17d2f4bf0ba1c5331a8ac11a3~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![comp2.jpg](https://s.poetries.top/md/55446bb6f2084ff4accd323d1b1e3d10~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![comp4.jpg](https://s.poetries.top/md/420d13489ede4563a8bd98c77da6ff6c~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
### [#](#_5-操作-props-小技巧) 5 操作 props 小技巧
...
![prop3.jpg](https://s.poetries.top/md/2c6e97d8421e42b29b086b8f8d5e60df~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
![prop4.jpg](https://s.poetries.top/md/51787c8ccd424afa9eeb3a857199403b~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)
...
## [#](#三-进阶实践-实现一个简单的-form-formitem-嵌套组件) 三 进阶实践-实现一个简单的 `<Form> <FormItem>`嵌套组件
...
![comp5.gif](https://s.poetries.top/md/8091336918af400380f7318f69e806de~tplv-k3u1fbpfcp-zoom-in-crop-mark_1304_0_0_0.png)

### [#](#_1-编写-form) 1 编写 `<Form>`
